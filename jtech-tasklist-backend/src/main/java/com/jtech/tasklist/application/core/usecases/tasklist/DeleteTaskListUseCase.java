...
import com.jtech.tasklist.ports.input.DeleteTaskListPort;
import com.jtech.tasklist.ports.output.TaskListRepositoryPort;
import org.springframework.stereotype.Service;

@Service
public class DeleteTaskListUseCase implements DeleteTaskListPort {

    private final TaskListRepositoryPort taskListRepositoryPort;

    public DeleteTaskListUseCase(TaskListRepositoryPort taskListRepositoryPort) {
    ...
    public void execute(Long id, Long userId) {
        ...
        taskListRepositoryPort.deleteById(id);
    }
}
