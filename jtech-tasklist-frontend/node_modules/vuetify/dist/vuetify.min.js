...
return l}function ae(e,t,a){const l=ee(e)
...
n?n.focus():ae(e,"next"===t?"first":"last",a)}}function le(e){return null==e||"string"==typeof e&&""===e.trim()}function ne(){}function oe(e,t){if(!(o&&"undefined"!=typeof CSS&&void 0!==CSS.supports&&CSS.supports(`selector(${t})`)))return null
...
return $(Math.floor((e+r)/i+1e-9)*i-r/2,0,100)}}}(e,I)
...
if(!Cn(e)){const a=new we(t),o=Nn(e)?e.touches[e.touches.length-1]:e,r=Se([o.clientX,o.clientY])
...
if(null!==l)if(t.preventDefault(),"track"===e.navigationStrategy){const e=B(l);-1!==e&&(C.value=e)}else F(l)}function $(e){I.value=!0}function F(e,t){if(_.value)return ae(_.value,e,t)}return Bt(()=>{const a=e.indent??(e.prependGap?Number(e.prependGap)+24:void 0),o=N.value?l.ariaMultiselectable??!String(e.selectStrategy).startsWith("single-"):void 0
...
function ts(e,t,a){return function(l){return!(l.relatedTarget||document.activeElement!==document.body||!e.value)&&(requestAnimationFrame(()=>{if(!e.value)return
const l=t(),n=(l&&ee(l)[0])??a()
n?.focus({preventScroll:!0})}),!0)}}function as(e,a){const l=t.shallowRef(!1)
let n
...
break}}}}}function ls(e){let{groups:a,onLeave:l}=e
...
i[u].at(e?0:-1).focus()}}}}}const ns=(e,t,a)=>{if(null==e||null==t)return-1
...
return l.length?l:-1}
function os(e,t){if(null!=e&&"boolean"!=typeof e&&-1!==e)return"number"==typeof e?[[e,e+t.length]]:Array.isArray(e[0])?e:[e]}const rs=vt({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function is(e,a,l,n){const o=t.shallowRef([]),r=t.shallowRef(new Map),i=t.computed(()=>n?.transform?t.unref(a).map(e=>[e,n.transform(e)]):t.unref(a))
return t.watchEffect(()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],n=a?.default??ns,o=!!a?.filterKeys&&B(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
if(p=o?o(l,t,u):n(l,t,u),-1!==p&&!1!==p)o?d[e]=os(p,t):v[e]=os(p,t)
else if("every"===a?.filterMode)continue e}}else p=n(u,t,u),-1!==p&&!1!==p&&(v.title=os(p,t))
...
const l=d[t]
v.push(l),p.set(l.value,a)}),o.value=v,r.value=p}),{filteredItems:o,filteredMatches:r,getMatches:function(e){return r.value.get(e.value)}}}function ss(e,a,l){return null!=l&&l.length?l.map((n,o)=>{const r=0===o?0:l[o-1][1],i=[t.createElementVNode("span",{class:t.normalizeClass(`${e}__unmask`)},[a.slice(r,n[0])]),t.createElementVNode("span",{class:t.normalizeClass(`${e}__mask`)},[a.slice(n[0],n[1])])]
return o===l.length-1&&i.push(t.createElementVNode("span",{class:t.normalizeClass(`${e}__unmask`)},[a.slice(n[1])])),t.createElementVNode(t.Fragment,null,[i])}):a}const us=vt({closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"}},"autocomplete")
function cs(e,a){const l=t.useId(),n=t.computed(()=>`menu-${l}`),o=t.toRef(()=>t.toValue(a)),r=t.toRef(()=>n.value)
return{menuId:n,ariaExpanded:o,ariaControls:r}}const ds=vt({chips:Boolean,closableChips:Boolean,eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Dt,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,noAutoScroll:Boolean,...us(),...Ar({itemChildren:!1})},"Select"),vs=vt({search:String,...rs({filterKeys:["title"]}),...ds(),...I(Gi({modelValue:null,role:"combobox"}),["validationValue","dirty"]),...gl({transition:{component:za}})},"VSelect"),ps=wt()({name:"VSelect",props:vs(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0,"update:search":e=>!0},setup(e,a){let{slots:l}=a
const{t:n}=ma(),r=t.ref(),i=t.ref(),s=t.ref(),u=t.ref(),c=t.ref(),{items:d,transformIn:v,transformOut:p}=Dr(e),m=la(e,"search",""),{filteredItems:f,getMatches:g}=is(e,d,()=>m.value),h=la(e,"modelValue",[],e=>v(null===e?[null]:B(e)),t=>{const a=p(t)
...
return e.hideSelected?t.filter(t=>!h.value.some(a=>(e.valueComparator||St)(a,t))):t}),_=t.computed(()=>e.hideNoData&&!I.value.length||b.isReadonly.value||b.isDisabled.value),P=la(e,"menu"),A=t.computed({get:()=>P.value,set:e=>{P.value&&!e&&i.value?.ΨopenChildren.size||e&&_.value||(P.value=e)}}),{menuId:R,ariaExpanded:T,ariaControls:D}=cs(0,A),$=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),F=t.ref(),M=as(F,r),z=ts(A,()=>i.value?.contentEl,()=>r.value?.controlRef),{onTabKeydown:L}=ls({groups:[{type:"element",contentRef:s},{type:"list",contentRef:F,displayItemsCount:()=>I.value.length},{type:"element",contentRef:u}],onLeave:()=>{A.value=!1,r.value?.focus()}})
function O(t){e.openOnClear&&(A.value=!0)}function j(){_.value||(A.value=!A.value)}function H(e){"Tab"===e.key&&L(e),F.value?.$el.contains(e.target)&&ue(e)&&W(e)}function W(t){if(!t.key||b.isReadonly.value)return
if(["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(A.value=!0),["Escape","Tab"].includes(t.key)&&(A.value=!1),e.clearable&&"Backspace"===t.key)return t.preventDefault(),h.value=[],void O()
...
if(!o)return
const[r,i]=o
E=i,F.value?.focus(i),e.multiple||(h.value=[r])}function Y(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
h.value=e?[a]:[],t.nextTick(()=>{A.value=!1})}}function U(e){const t=e.target
r.value?.$el.contains(t)||(A.value=!1)}function G(){if(e.eager&&c.value?.calculateVisibleItems(),F.value&&k.value){const t=function(){if(!h.value.length)return-1
...
F.value.focus(t>=0?t:"first",{focusVisible:!1})}}function K(){m.value="",k.value&&r.value?.focus()}function q(e){k.value=!0}function X(e){if(!r.value?.$el.contains(e.relatedTarget)){if(z(e))return
k.value=!1}}function Z(e){if(null==e)h.value=[]
else if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=d.value.find(t=>t.title===e)
t&&Y(t)}else r.value&&(r.value.value="")}return t.watch(A,()=>{if(!e.hideSelected&&A.value&&h.value.length){const t=I.value.findIndex(t=>h.value.some(a=>(e.valueComparator||St)(a.value,t.value)))
...
return e.multiple?a:a[0]??null}),k=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(w.value):"number"==typeof e.counterValue?e.counterValue:w.value.length),S=go(e),{filteredItems:x,getMatches:N}=is(e,m,()=>p.value??(s.value?"":V.value)),C=t.computed(()=>e.hideSelected&&null===p.value?x.value.filter(e=>!w.value.some(t=>t.value===e.value)):x.value),E=t.toRef(()=>e.closableChips&&!S.isReadonly.value&&!S.isDisabled.value),I=t.computed(()=>!(!e.chips&&!l.chip)),_=t.computed(()=>I.value||!!l.selection),P=t.computed(()=>w.value.map(e=>e.props.value)),A=t.computed(()=>C.value.find(e=>"item"===e.type&&!e.props.disabled)),R=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&V.value===A.value?.title)&&C.value.length>0&&!s.value&&!u.value),T=t.computed(()=>e.hideNoData&&!C.value.length||S.isReadonly.value||S.isDisabled.value),D=la(e,"menu"),$=t.computed({get:()=>D.value,set:e=>{D.value&&!e&&c.value?.ΨopenChildren.size||e&&T.value||(D.value=e)}}),{menuId:F,ariaExpanded:M,ariaControls:z}=cs(0,$),L=t.ref(),O=t.ref(),j=t.ref(),H=as(L,r),W=ts($,()=>c.value?.contentEl,()=>r.value?.controlRef),{onTabKeydown:Y}=ls({groups:[{type:"element",contentRef:O},{type:"list",contentRef:L,displayItemsCount:()=>C.value.length},{type:"element",contentRef:j}],onLeave:()=>{$.value=!1,r.value?.focus()}})
function U(t){e.openOnClear&&($.value=!0),V.value=""}function G(){T.value||($.value=!0)}function K(e){T.value||(i.value&&(e.preventDefault(),e.stopPropagation()),$.value=!$.value)}function q(e){"Tab"===e.key&&Y(e),L.value?.$el.contains(e.target)&&(ue(e)||"Backspace"===e.key)&&r.value?.focus()}function X(t){if(S.isReadonly.value)return
...
return t===A.value.value})&&se(A.value),"ArrowDown"===t.key&&R.value&&L.value?.focus("next"),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&_.value&&w.value.length>0&&!V.value)return se(w.value[0],!1)
if(~v.value){t.preventDefault()
const e=v.value
se(w.value[v.value],!1),v.value=e>=l-1?l-2:e}else"Backspace"!==t.key||V.value||(v.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(v.value<0&&a&&a>0)return
...
const e=v.value+1
w.value[e]?v.value=e:(v.value=-1,r.value?.setSelectionRange(0,0))}else~v.value&&ue(t)&&(v.value=-1)}function Z(e){if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=m.value.find(t=>t.title===e.target.value)
t&&se(t)}}function Q(){e.eager&&d.value?.calculateVisibleItems()}function J(){i.value&&(s.value=!0,r.value?.focus()),p.value=null}function ee(e){i.value=!0,setTimeout(()=>{u.value=!0})}function te(e){if(u.value=!1,!r.value?.$el.contains(e.relatedTarget)){if(W(e))return
i.value=!1}}function ae(t){null!=t&&(""!==t||e.multiple||_.value)||(w.value=[])}function le(e){const t=c.value?.contentEl
t?.contains(e.relatedTarget)&&(i.value=!0)}const ie=t.shallowRef(!1)
function se(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
w.value=e?[a]:[],p.value=s.value?"":V.value??"",V.value=e&&!_.value?a.title:"",t.nextTick(()=>{$.value=!1,s.value=!0})}}return t.watch(i,(a,l)=>{a!==l&&(a?(ie.value=!0,V.value=e.multiple||_.value?"":String(w.value.at(-1)?.props.title??""),s.value=!0,t.nextTick(()=>ie.value=!1)):(e.multiple||null!=V.value||(w.value=[]),$.value=!1,!s.value&&V.value&&(p.value=V.value),V.value="",v.value=-1))}),t.watch(V,e=>{i.value&&!ie.value&&(e&&($.value=!0),s.value=!e)}),t.watch($,t=>{if(!e.hideSelected&&t&&w.value.length&&s.value){const e=C.value.findIndex(e=>w.value.some(t=>e.value===t.value))
...
return t.createVNode(Ki,t.mergeProps({ref:r},u,{modelValue:V.value,"onUpdate:modelValue":[e=>V.value=e,ae],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:w.externalValue,counterValue:k.value,dirty:o,onChange:Z,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":$.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!_.value,"v-autocomplete--selecting-index":v.value>-1},e.class],style:e.style,readonly:S.isReadonly.value,placeholder:o?void 0:e.placeholder,"onClick:clear":U,"onMousedown:control":G,onKeydown:X,onBlur:le,"aria-expanded":M.value,"aria-controls":z.value}),{...l,default:o=>{let{id:r}=o
return t.createElementVNode(t.Fragment,null,[t.createVNode(Ti,t.mergeProps({id:F.value,ref:c,modelValue:$.value,"onUpdate:modelValue":e=>$.value=e,activator:"parent",disabled:T.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,onAfterEnter:Q,onAfterLeave:J},e.menuProps,{contentClass:["v-autocomplete__content",e.menuProps?.contentClass]}),{default:()=>[t.createVNode(Di,{onFocusin:ee,onKeydown:q},{default:()=>[l["menu-header"]&&t.createElementVNode("header",{ref:O},[l["menu-header"](p)]),a&&t.createVNode(Or,t.mergeProps({key:"autocomplete-list",ref:L,filterable:!0,selected:P.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusout:te,tabindex:"-1",selectable:!!C.value.length,"aria-live":"polite","aria-labelledby":`${r.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},H,e.listProps),{default:()=>[l["prepend-item"]?.(),!C.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(es,{ref:d,renderless:!0,items:C.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
const i=t.mergeProps(n.props,{ref:r,key:n.value,active:!(!R.value||n!==A.value)||void 0,onClick:()=>se(n,null),"aria-posinset":o+1,"aria-setsize":C.value.length})
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(io,{key:n.value,modelValue:l,ripple:!1,tabindex:"-1","aria-hidden":!0,onClick:e=>e.preventDefault()},null):void 0,n.props.prependAvatar&&t.createVNode(Zn,{image:n.props.prependAvatar},null),n.props.prependIcon&&t.createVNode(nn,{icon:n.props.prependIcon},null)])},title:()=>s.value?n.title:ss("v-autocomplete",n.title,N(n)?.title)})}}),l["append-item"]?.()]}),l["menu-footer"]&&t.createElementVNode("footer",{ref:j},[l["menu-footer"](p)])]})]}),w.value.map((a,n)=>{function o(e){e.stopPropagation(),e.preventDefault(),se(a,!1)}const r=t.mergeProps(Jo.filterProps(a.props),{"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),i=I.value?!!l.chip:!!l.selection,s=i?re(I.value?l.chip({item:a,index:n,props:r}):l.selection({item:a,index:n})):void 0
...
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...n),e.menuIcon?t.createVNode(nn,{class:"v-autocomplete__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon,onMousedown:K,onClick:ne,"aria-hidden":!0,tabindex:"-1"},null):void 0,e.appendInnerIcon&&t.createVNode(b,{key:"append-icon",name:"appendInner",color:n[0].iconColor.value},null)])}})}),xo({isFocused:i,isPristine:s,menu:$,search:V,filteredItems:x,select:se},r)}}),gs=vt({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Dt,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...pt(),...Il({location:"top end"}),...ml(),...Pa(),...ya(),...gl({transition:"scale-rotate-transition"}),...rl()},"VBadge"),hs=wt()({name:"VBadge",inheritAttrs:!1,props:gs(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:n}=vl(()=>e.color),{roundedClasses:o}=fl(e),{t:r}=ma(),{textColorClasses:i,textColorStyles:s}=dl(()=>e.textColor),{themeClasses:u}=Ea(),{locationStyles:c}=_l(e,!0,t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?Number(e.offsetY??0):["left","right"].includes(t)?Number(e.offsetX??0):0)),{dimensionStyles:d}=il(e)
...
return t.createVNode(ol,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})}),xo({},i)}}),Es=vt({inset:Boolean,...Ns({transition:"bottom-sheet-transition"})},"VBottomSheet"),Is=wt()({name:"VBottomSheet",props:Es(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"modelValue")
return Bt(()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)}),{}}}),_s=vt({divider:[Number,String],...pt()},"VBreadcrumbsDivider"),Ps=wt()({name:"VBreadcrumbsDivider",props:_s(),setup(e,a){let{slots:l}=a
return Bt(()=>t.createElementVNode("li",{"aria-hidden":"true",class:t.normalizeClass(["v-breadcrumbs-divider",e.class]),style:t.normalizeStyle(e.style)},[l?.default?.()??e.divider])),{}}}),As=vt({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...pt(),...C(rl(),["width","maxWidth"]),...wn(),...Pa({tag:"li"})},"VBreadcrumbsItem"),Rs=wt()({name:"VBreadcrumbsItem",props:As(),setup(e,a){let{slots:l,attrs:n}=a
...
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,[`${e.activeClass}`]:r.value&&e.activeClass},s.value,e.class]),style:t.normalizeStyle([u.value,i.value,e.style]),"aria-current":r.value?"page":void 0},{default:()=>[o.isLink.value?t.createElementVNode("a",t.mergeProps({class:"v-breadcrumbs-item--link",onClick:o.navigate.value},o.linkProps),[l.default?.()??e.title]):l.default?.()??e.title]})),{}}}),Ts=vt({activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:Dt,items:{type:Array,default:()=>[]},...pt(),...Ml(),...ml(),...Pa({tag:"ul"})},"VBreadcrumbs"),Bs=wt()({name:"VBreadcrumbs",props:Ts(),setup(e,a){let{slots:l}=a
...
return t.createElementVNode(t.Fragment,null,[l.item?.({item:o,index:a})??t.createVNode(Rs,t.mergeProps({key:a,disabled:a>=n.length-1},"string"==typeof o?{title:o}:o),{default:l.title?()=>l.title?.({item:o,index:a}):void 0}),a<n.length-1&&t.createVNode(Ps,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])}),l.default?.()]})}),{}}}),Ds=vt({active:{type:Boolean,default:void 0},activeColor:String,activeIcon:[String,Function,Object],activeVariant:String,baseVariant:{type:String,default:"tonal"},disabled:Boolean,height:[Number,String],width:[Number,String],hideOverlay:Boolean,icon:[String,Function,Object],iconColor:String,loading:Boolean,opacity:[Number,String],readonly:Boolean,rotate:[Number,String],size:{type:[Number,String],default:"default"},sizes:{type:Array,default:()=>[["x-small",16],["small",24],["default",40],["large",48],["x-large",56]]},text:{type:[String,Number,Boolean],default:void 0},...Sl(),...pt(),...Nl(),...Yn(),...ml(),...Pa({tag:"button"}),...ya(),...jl({variant:"flat"})},"VIconBtn"),$s=wt()({name:"VIconBtn",props:Ds(),emits:{"update:active":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
const Fs=/^(\d{4})-(\d{1,2})(-(\d{1,2}))?([^\d]+(\d{1,2}))?(:(\d{1,2}))?(:(\d{1,2}))?$/,Ms=/(\d\d?)(:(\d\d?)|)(:(\d\d?)|)/,zs=[0,31,28,31,30,31,30,31,31,30,31,30,31],Ls=[0,31,29,31,30,31,30,31,31,30,31,30,31]
function Os(e){const t=nu(e)
return t.day=1,tu(t),au(t),t}function js(e){const t=nu(e)
return t.day=lu(t.year,t.month),tu(t),au(t),t}function Hs(e){return isFinite(parseInt(e))}function Ws(e){if("number"==typeof e)return e
if("string"==typeof e){const t=Ms.exec(e)
return!!t&&60*parseInt(t[1])+parseInt(t[3]||0)}return"object"==typeof e&&("number"==typeof e.hour&&"number"==typeof e.minute&&60*e.hour+e.minute)}function Ys(e){return"number"==typeof e&&isFinite(e)||"string"==typeof e&&!!Fs.exec(e)||e instanceof Date}function Us(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],a=arguments.length>2?arguments[2]:void 0
if("number"==typeof e&&isFinite(e)&&(e=new Date(e)),e instanceof Date){const t=Gs(e)
return a&&Zs(t,a,t.hasTime),t}if("string"!=typeof e){if(t)throw new Error(`${e} is not a valid timestamp. It must be a Date, number of milliseconds since Epoch, or a string in the format of YYYY-MM-DD or YYYY-MM-DD hh:mm. Zero-padding is optional and seconds are ignored.`)
return null}const l=Fs.exec(e)
...
return tu(n),au(n),a&&Zs(n,a,n.hasTime),n}function Gs(e){return au({date:"",time:"",year:e.getFullYear(),month:e.getMonth()+1,day:e.getDate(),weekday:e.getDay(),hour:e.getHours(),minute:e.getMinutes(),hasDay:!0,hasTime:!0,past:!1,present:!0,future:!1})}function Ks(e){return 1e4*e.year+100*e.month+e.day}function qs(e){return 100*e.hour+e.minute}function Xs(e){return 1e4*Ks(e)+qs(e)}function Zs(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=Ks(t),n=Ks(e),o=l===n
return e.hasTime&&a&&o&&(l=qs(t),n=qs(e),o=l===n),e.past=n<l,e.present=o,e.future=n>l,e}function Qs(e){return e instanceof Date||"number"==typeof e&&isFinite(e)}function Js(e,t,a){return e.hasTime!==t&&(e.hasTime=t,t||(e.hour=23,e.minute=59,e.time=ru(e))),e}function eu(e,t,a){return e.hasTime=!0,e.hour=0,e.minute=0,iu(e,t),au(e),a&&Zs(e,a,!0),e}function tu(e){return e.weekday=function(e){if(e.hasDay){const t=Math.floor,a=e.day,l=(e.month+9)%12+1,n=t(e.year/100),o=e.year%100-(e.month<=2?1:0)
return((a+t(2.6*l-.2)-2*n+o+t(o/4)+t(n/4))%7+7)%7}return e.weekday}(e),e}function au(e){return e.time=ru(e),e.date=function(e){let t=`${ou(e.year,4)}-${ou(e.month,2)}`
e.hasDay&&(t+=`-${ou(e.day,2)}`)
return t}(e),e}function lu(e,t){return function(e){return e%4==0&&e%100!=0||e%400==0}(e)?Ls[t]:zs[t]}function nu(e){if(null==e)return null
const{date:t,time:a,year:l,month:n,day:o,weekday:r,hour:i,minute:s,hasDay:u,hasTime:c,past:d,present:v,future:p}=e
return{date:t,time:a,year:l,month:n,day:o,weekday:r,hour:i,minute:s,hasDay:u,hasTime:c,past:d,present:v,future:p}}function ou(e,t){let a=String(e)
for(;a.length<t;)a="0"+a
return a}function ru(e){return e.hasTime?`${ou(e.hour,2)}:${ou(e.minute,2)}`:""}function iu(e,t){for(e.minute+=t;e.minute>=60;)e.minute-=60,e.hour++,e.hour>=24&&(su(e),e.hour=0)
return e}function su(e){return e.day++,e.weekday=(e.weekday+1)%7,e.day>28&&e.day>lu(e.year,e.month)&&(e.day=1,e.month++,e.month>12&&(e.month=1,e.year++)),e}function uu(e){return e.day--,e.weekday=(e.weekday+6)%7,e.day<1&&(e.month--,e.month<1&&(e.year--,e.month=12),e.day=lu(e.year,e.month)),e}function cu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:su,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
for(;--a>=0;)t(e)
return e}function du(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:su,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:6
for(;e.weekday!==t&&--l>=0;)a(e)
return e}function vu(e){const t=`${ou(e.hour,2)}:${ou(e.minute,2)}`,a=e.date
return new Date(`${a}T${t}:00+00:00`)}function pu(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:42,o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:0
const r=Ks(t),i=[]
let s=nu(e),u=0,c=u===r
if(r<Ks(e))throw new Error("End date is earlier than start date.")
for(;(!c||i.length<o)&&i.length<n;){if(u=Ks(s),c=c||u===r,0===l[s.weekday]){s=su(s)
continue}const e=nu(s)
au(e),Zs(e,a),i.push(e),s=cu(s,su,l[s.weekday])}if(!i.length)throw new Error("No dates found using specified start date, end date, and weekdays.")
return i}function mu(e,t){const a=(e,t)=>""
return"undefined"==typeof Intl||void 0===Intl.DateTimeFormat?a:(a,l)=>{try{return new Intl.DateTimeFormat(e||void 0,t(a,l)).format(vu(a))}catch(e){return""}}}function fu(e){const t=e.slice(-2).toUpperCase()
...
default:return null}}function gu(e,t,l){let n=(l??fu(t)?.firstDay??0)%7;[0,1,2,3,4,5,6].includes(n)||(a("Invalid firstDayOfWeek, expected discrete number in range [0-6]"),n=0)
const o=new Date(e)
for(;o.getDay()!==n;)o.setDate(o.getDate()-1)
return o}function hu(e){return new Date(e.getFullYear(),e.getMonth(),1)}function yu(e){return new Date(e.getFullYear(),e.getMonth()+1,0)}const bu=/^([12]\d{3}-([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[12]\d|3[01]))$/
function Vu(e){if(null==e)return new Date
if(e instanceof Date)return e
if("string"==typeof e){let t
if(bu.test(e))return function(e){const t=e.split("-").map(Number)
return new Date(t[0],t[1]-1,t[2])}(e)
if(t=Date.parse(e),!isNaN(t))return new Date(t)}return null}const wu=new Date(2e3,0,2)
function ku(e,t,a,l){const n=Vu(e)??new Date,o=l?.[t]
...
default:r=o??{timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(a,r).format(n)}function Su(e,t){const a=new Date(e)
return a.setDate(a.getDate()+t),a}function xu(e){return e.getFullYear()}function Nu(e,t,a,l){const n=fu(t),o=a??n?.firstDay??0,r=n?.firstWeekSize??1
return void 0!==l?function(e,t,a,l){const n=(7+l-a)%7,o=gu(e,t,a),r=Su(o,6)
function i(e){return(7+new Date(e,0,1).getDay()-a)%7}let s=xu(o)
s<xu(r)&&i(s+1)<=n&&s++
const u=new Date(s,0,1),c=i(s),d=Su(u,c<=n?-c:7-c)
return 1+Iu(Pu(o),_u(d),"weeks")}(e,t,o,l):function(e,t,a,l){const n=gu(e,t,a),o=Su(gu(e,t,a),6)
function r(e){const l=new Date(e,0,1)
return 7-Iu(l,gu(l,t,a),"days")}let i=xu(n)
i<xu(o)&&r(i+1)>=l&&i++
const s=new Date(i,0,1),u=r(i),c=Su(s,u>=l?u-7:u)
return 1+Iu(Pu(n),_u(c),"weeks")}(e,t,o,r)}function Cu(e,t){return e.getTime()>t.getTime()}function Eu(e,t){return e.getTime()===t.getTime()}function Iu(e,t,a){const l=new Date(e),n=new Date(t)
...
default:return l.getTime()-n.getTime()}}function _u(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0)}function Pu(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}class Au{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return Vu(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
return a.setHours(a.getHours()+t),a}(e,t)}addDays(e,t){return Su(e,t)}addWeeks(e,t){return function(e,t){const a=new Date(e)
...
let n=[]
const o=hu(e),r=yu(e),i=a??fu(t)?.firstDay??0,s=(o.getDay()-i+7)%7,u=(r.getDay()-i+7)%7
...
return gu(e,this.locale,a)}endOfWeek(e){return function(e,t){const a=new Date(e),l=((fu(t)?.firstDay??0)+6)%7
for(;a.getDay()!==l;)a.setDate(a.getDate()+1)
return a}(e,this.locale)}startOfMonth(e){return hu(e)}endOfMonth(e){return yu(e)}format(e,t){return ku(e,t,this.locale,this.formats)}isEqual(e,t){return Eu(e,t)}isValid(e){return function(e){const t=new Date(e)
return t instanceof Date&&!isNaN(t.getTime())}(e)}isWithinRange(e,t){return function(e,t){return Cu(e,t[0])&&function(e,t){return e.getTime()<t.getTime()}(e,t[1])}(e,t)}isAfter(e,t){return Cu(e,t)}isAfterDay(e,t){return function(e,t){return Cu(_u(e),_u(t))}(e,t)}isBefore(e,t){return!Cu(e,t)&&!Eu(e,t)}isSameDay(e,t){return function(e,t){return e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameMonth(e,t){return function(e,t){return e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameYear(e,t){return function(e,t){return e.getFullYear()===t.getFullYear()}(e,t)}setMinutes(e,t){return function(e,t){const a=new Date(e)
...
return a.setFullYear(t),a}(e,t)}getDiff(e,t,a){return Iu(e,t,a)}getWeekdays(e,t){const a=void 0!==e?Number(e):void 0
return function(e,t,a){const l=t??fu(e)?.firstDay??0
return y(7).map(t=>{const n=new Date(wu)
return n.setDate(wu.getDate()+l+t),new Intl.DateTimeFormat(e,{weekday:a??"narrow"}).format(n)})}(this.locale,a,t)}getYear(e){return xu(e)}getMonth(e){return function(e){return e.getMonth()}(e)}getWeek(e,t,a){const l=void 0!==t?Number(t):void 0,n=void 0!==a?Number(a):void 0
return Nu(e,this.locale,l,n)}getDate(e){return function(e){return e.getDate()}(e)}getNextMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()+1,1)}(e)}getPreviousMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()-1,1)}(e)}getHours(e){return function(e){return e.getHours()}(e)}getMinutes(e){return function(e){return e.getMinutes()}(e)}startOfDay(e){return _u(e)}endOfDay(e){return Pu(e)}startOfYear(e){return function(e){return new Date(e.getFullYear(),0,1)}(e)}endOfYear(e){return function(e){return new Date(e.getFullYear(),11,31)}(e)}}const Ru=Symbol.for("vuetify:date-options"),Tu=Symbol.for("vuetify:date-adapter")
function Bu(e,t,a){const l=[`${e.toISO(a??t).split("T")[0]}T00:00:00Z`,`${e.toISO(t).split("T")[0]}T00:00:00Z`]
return"string"==typeof e.date()?e.getDiff(l[0],l[1],"days"):e.getDiff(e.date(l[0]),e.date(l[1]),"days")}function Du(e,a){const l=t.reactive("function"==typeof e.adapter?new e.adapter({locale:e.locale[a.current.value]??a.current.value,formats:e.formats}):e.adapter)
return t.watch(a.current,t=>{l.locale=e.locale[t]??t??l.locale}),l}function $u(){const e=t.inject(Ru)
if(!e)throw new Error("[Vuetify] Could not find injected date options")
return Du(e,ma())}const Fu=vt({start:{type:[String,Number,Date],validate:Ys,default:()=>Gs(new Date).date},end:{type:[String,Number,Date],validate:Ys},weekdays:{type:[Array,String],default:()=>[0,1,2,3,4,5,6],validate:function(e){if("string"==typeof e&&(e=e.split(",")),Array.isArray(e)){const t=e.map(e=>parseInt(e))
...
a[n]=!0}return!0}return!1}},firstDayOfWeek:[Number,String],firstDayOfYear:[Number,String],weekdayFormat:{type:Function,default:null},dayFormat:{type:Function,default:null},locale:String,now:{type:String,validator:Ys},type:{type:String,default:"month"}},"VCalendar-base")
function Mu(e){const{times:a,updateTimes:l}=function(e){const a=t.reactive({now:Us("0000-00-00 00:00",!0),today:Us("0000-00-00",!0)}),l=t.computed(()=>e.now&&Ys(e.now)?Us(e.now,!0):null)
function n(){a.now.present=a.today.present=!0,a.now.past=a.today.past=!1,a.now.future=a.today.future=!1}function o(){return Gs(new Date)}function r(e,t){e.date!==t.date&&(t.year=e.year,t.month=e.month,t.day=e.day,t.weekday=e.weekday,t.date=e.date)}function i(e,t){e.time!==t.time&&(t.hour=e.hour,t.minute=e.minute,t.time=e.time)}function s(){const e=l.value||o()
r(e,a.now),i(e,a.now),r(e,a.today)}return t.watch(l,s),s(),n(),{times:a,parsedNow:l,updateTimes:s,setPresent:n,getNow:o,updateDay:r,updateTime:i}}({now:e.now}),n=fa(e),o=$u(),r=t.computed(()=>"month"===e.type?Os(Us(e.start,!0)):Us(e.start,!0)),i=t.computed(()=>{const t=r.value,a=e.end&&Us(e.end)||t,l=Xs(a)<Xs(t)?t:a
return"month"===e.type?js(l):l}),s=t.computed(()=>Ys(e.modelValue)?Us(e.modelValue,!0):r.value||a.today),u=t.computed(()=>{const t=Array.isArray(e.weekdays)?e.weekdays:(e.weekdays||"").split(",").map(e=>parseInt(e,10)),a=o.toJsDate(o.startOfWeek(o.date(),e.firstDayOfWeek)).getDay()
...
t[e]=a[e]*l}return t}(u.value)),v=t.computed(()=>pu(r.value,i.value,a.today,d.value)),p=t.computed(()=>e.dayFormat?e.dayFormat:mu(n.current.value,()=>({timeZone:"UTC",day:"numeric"}))),m=t.computed(()=>e.weekdayFormat?e.weekdayFormat:mu(n.current.value,(e,t)=>({timeZone:"UTC",weekday:t?"short":"long"})))
...
return{"v-present":e.present,"v-past":e.past,"v-future":e.future,"v-outside":t}},getWeekNumber:function(t){return o.getWeek(o.date(t.date),e.firstDayOfWeek,e.firstDayOfYear)},getStartOfWeek:function(e){return function(e,t,a){const l=nu(e)
return du(l,t[0],uu),au(l),a&&Zs(l,a,l.hasTime),l}(e,u.value,a.today)},getEndOfWeek:function(e){return function(e,t,a){const l=nu(e)
return du(l,t[t.length-1]),au(l),a&&Zs(l,a,l.hasTime),l}(e,u.value,a.today)},getFormatter:function(e){return mu(n.current.value,()=>e)},updateTimes:l}}const zu=vt({maxDays:{type:Number,default:7},intervalHeight:{type:[Number,String],default:48,validate:Hs},intervalWidth:{type:[Number,String],default:60,validate:Hs},intervalMinutes:{type:[Number,String],default:60,validate:Hs},firstInterval:{type:[Number,String],default:0,validate:Hs},firstTime:{type:[Number,String,Object],validate:function(e){return"number"==typeof e&&isFinite(e)||!!Ms.exec(e)||"object"==typeof e&&isFinite(e.hour)&&isFinite(e.minute)}},intervalCount:{type:[Number,String],default:24,validate:Hs},intervalFormat:{type:Function,default:null},intervalStyle:{type:Function,default:null},showIntervalLabel:{type:Function,default:null}},"VCalendar-intervals")
function Lu(e){const a=Mu(e),l=t.shallowRef(),n=t.computed(()=>parseInt(String(e.firstInterval||0))),o=t.computed(()=>parseInt(String(e.intervalMinutes||60))),r=t.computed(()=>parseInt(String(e.intervalCount||24))),i=t.computed(()=>parseFloat(String(e.intervalHeight||48))),s=t.computed(()=>Ws(e.firstTime)),u=t.computed(()=>{const e=s.value
return!1!==e&&e>=0&&e<=1440?e:n.value*o.value}),c=t.computed(()=>r.value*i.value),d=t.computed(()=>pu(a.parsedStart.value,a.parsedEnd.value,a.times.today,a.weekdaySkips.value,e.maxDays)),v=t.computed(()=>{const e=d.value,t=u.value,l=o.value,n=r.value,i=a.times.now
return e.map(e=>function(e,t,a,l,n){const o=[]
for(let r=0;r<l;r++){const l=t+r*a,i=nu(e)
o.push(eu(i,l,n))}return o}(e,t,l,n,i))}),p=t.computed(()=>e.intervalFormat?e.intervalFormat:mu(a.locale.current.value,(e,t)=>t?0===e.minute?{timeZone:"UTC",hour:"numeric"}:{timeZone:"UTC",hour:"numeric",minute:"2-digit"}:{timeZone:"UTC",hour:"2-digit",minute:"2-digit"}))
...
return!1===l||(l*=c.value,a?l<0?l=0:l>c.value&&(l=c.value):l<0?l+=c.value:l>c.value&&(l-=c.value)),l}function g(e,t){let a=Ws(e)
if(!1===a)return!1
const l=r.value*o.value
if(t&&"object"==typeof e&&"day"in e){a+=(Ks(e)-Ks(t))*l}return(a-u.value)/l}return{...a,scrollAreaRef:l,parsedFirstInterval:n,parsedIntervalMinutes:o,parsedIntervalCount:r,parsedIntervalHeight:i,parsedFirstTime:s,firstMinute:u,bodyHeight:c,days:d,intervals:v,intervalFormatter:p,showIntervalLabelDefault:function(e){const t=v.value[0][0]
return!(t.hour===e.hour&&t.minute===e.minute)},intervalStyleDefault:function(e){},getTimestampAtEvent:function(e,t){const l=nu(t),n=new we(e.currentTarget),r=u.value,s=e,c=e,d=s.changedTouches||s.touches,v=d&&d[0]?d[0]:c,p=(Se([v.clientX,v.clientY]).y-n.top)/i.value
return eu(l,r+Math.floor(p*o.value),a.times.now)},getSlotScope:function(e){const t=nu(e)
...
return!(!1===t||!a)&&(a.scrollTop=t,!0)},minutesToPixels:m,timeToY:f,timeDelta:g}}const Ou={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}},ju=Vt({name:"VCalendarDaily",directives:{vResize:Ou},props:{color:String,shortWeekdays:{type:Boolean,default:!0},shortIntervals:{type:Boolean,default:!0},hideHeader:Boolean,...Fu(),...zu()},setup(e,a){let{slots:l,attrs:n}=a
const o=t.ref(0),r=t.ref(),i=Lu(e)
...
return t.createElementVNode("div",t.mergeProps({key:e.date,class:["v-calendar-daily__day",i.getRelativeClasses(e)]},l),[y(a),h(e)])})])])])])]),[[Ou,u,void 0,{quiet:!0}]])),{...i,scrollPush:o,pane:r,init:s,onResize:u,getScrollPush:c}}})
function Hu(e,t){return"string"==typeof e?e.split(/\s*,\s/):Array.isArray(e)?e.map(e=>{if("string"==typeof e)return e
...
return{...e,categoryName:a}}):[]}const Wu=Vt({name:"VCalendarCategory",props:{categories:{type:[Array,String],default:""},categoryText:[String,Function],categoryForInvalid:{type:String,default:""},...Fu(),...zu()},setup(e,a){let{slots:l,attrs:n}=a
const o=Lu(e),r=t.computed(()=>Hu(e.categories,e.categoryText))
...
return t.createElementVNode("div",t.mergeProps({class:"v-calendar-category__column"},r),[l["day-body"]?.(i(o.getSlotScope(e),a))])}return Bt(()=>t.createVNode(ju,t.mergeProps({class:["v-calendar-daily","v-calendar-category"]},e),{...l,days:c,"day-header":s})),{...o,parsedCategories:r}}}),Yu={control:"ctrl",command:"cmd",option:"alt",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright",esc:"escape",spacebar:" ",space:" ",return:"enter",del:"delete",plus:"+",slash:"/",underscore:"_",minus:"-",hyphen:"-"}
function Uu(e){const t=e.toLowerCase()
return Yu[t]||t}function Gu(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
...
const n=[],o=[]
let r=""
const i=e=>{r&&(e&&o.push(e),n.push(Uu(r)),r="")}
for(let t=0;t<e.length;t++){const a=e[t],l=e[t+1];["+","/","_","-"].includes(a)?a===l?(i(a),n.push(a),t++):["+","/","_"].includes(a)?i(a):r+=a:r+=a}i()
return n.some(e=>e.length>1&&e.includes("-")&&"--"!==e)?(t||a(`Invalid hotkey combination: "${e}" has invalid structure`),l):0===n.length&&e?{keys:[Uu(e)],separators:o}:{keys:n,separators:o}}function Ku(e){if(!e)return a("Invalid hotkey sequence: empty string provided"),[]
...
return i.every(e=>Gu(e,!0).keys.length>0)?i:(a(`Invalid hotkey sequence: "${e}" contains invalid combinations`),[])}const qu={"credit-card":"#### - #### - #### - ####",date:"##/##/####","date-time":"##/##/#### ##:##","iso-date":"####-##-##","iso-date-time":"####-##-## ##:##",phone:"(###) ### - ####",social:"###-##-####",time:"##:##","time-with-seconds":"##:##:##"},Xu={"#":{pattern:/[0-9]/},A:{pattern:/[A-Z]/i,convert:e=>e.toUpperCase()},a:{pattern:/[a-z]/i,convert:e=>e.toLowerCase()},N:{pattern:/[0-9A-Z]/i,convert:e=>e.toUpperCase()},n:{pattern:/[0-9a-z]/i,convert:e=>e.toLowerCase()},X:{pattern:/[-!$%^&*()_+|~=`{}[\]:";'<>?,./\\ ]/}}
const Zu=Vt({name:"VCalendarWeekly",props:{minWeeks:{validate:Hs,default:1},monthFormat:Function,showWeek:Boolean,color:String,shortWeekdays:{type:Boolean,default:!0},showMonthOnFirst:{type:Boolean,default:!0},shortMonths:{type:Boolean,default:!0},hideHeader:Boolean,...Fu()},setup(e,a){let{slots:l,attrs:n}=a
const o=Mu(e),r=Ea(),i=t.computed(()=>parseInt(String(e.minWeeks))),s=t.computed(()=>{const e=i.value*o.parsedWeekdays.value.length
return pu(o.getStartOfWeek(o.parsedStart.value),o.getEndOfWeek(o.parsedEnd.value),o.times.today,o.weekdaySkips.value,Number.MAX_SAFE_INTEGER,e)}),u=t.computed(()=>{const e=o.times.today
return pu(o.getStartOfWeek(e),o.getEndOfWeek(e),e,o.weekdaySkips.value,o.parsedWeekdays.value.length,o.parsedWeekdays.value.length)}),c=t.computed(()=>e.monthFormat?e.monthFormat:mu(o.locale.current.value,(e,t)=>({timeZone:"UTC",month:t?"short":"long"})))
function d(e){const t=Ks(e)
return t<Ks(o.parsedStart.value)||t>Ks(o.parsedEnd.value)}function v(){const a=u.value.map(p)
...
function Qu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
const a=e.map(e=>({event:e,columnCount:0,column:0,left:0,width:100}))
return a.sort((e,a)=>Math.max(t,e.event.startTimestampIdentifier)-Math.max(t,a.event.startTimestampIdentifier)||a.event.endTimestampIdentifier-e.event.endTimestampIdentifier),a}function Ju(e,t,a,l){return!(arguments.length>4&&void 0!==arguments[4])||arguments[4]?!(e>=l||t<=a):!(e>l||t<a)}function ec(e){e.forEach(t=>{t.visuals.forEach(t=>{t.columnCount=e.length})})}function tc(e){return[e.startTimestampIdentifier,e.endTimestampIdentifier]}function ac(e){return[e.startIdentifier,e.endIdentifier]}function lc(e,t){return[Math.max(t,e.startTimestampIdentifier),Math.min(t+864e5,e.endTimestampIdentifier)]}function nc(e){const t={groups:[],min:-1,max:-1,reset:()=>{t.groups=[],t.min=t.max=-1},getVisuals:function(a,l,n){let o=arguments.length>3&&void 0!==arguments[3]&&arguments[3];(a.weekday===e||o)&&t.reset()
const r=Qu(l,Xs(a))
return r.forEach(e=>{const[a,l]=n?tc(e.event):ac(e.event)
t.groups.length>0&&!Ju(a,l,t.min,t.max,n)&&(ec(t.groups),t.reset())
let o=function(e,t,a,l){for(let n=0;n<e.length;n++){const o=e[n]
let r=!1
if(Ju(t,a,o.start,o.end,l))for(let e=0;e<o.visuals.length;e++){const n=o.visuals[e],[i,s]=l?tc(n.event):ac(n.event)
if(Ju(t,a,i,s,l)){r=!0
break}}if(!r)return n}return-1}(t.groups,a,l,n);-1===o&&(o=t.groups.length,t.groups.push({start:a,end:l,visuals:[]}))
const r=t.groups[o]
r.visuals.push(e),r.start=Math.min(r.start,a),r.end=Math.max(r.end,l),e.column=o,-1===t.min?(t.min=a,t.max=l):(t.min=Math.min(t.min,a),t.max=Math.max(t.max,l))}),ec(t.groups),n&&t.reset(),r}}
return t}const oc=100
function rc(e,t){for(const a of e){const{visual:l,parent:n}=a,o=pc(a)+1,r=n?n.visual.left:0,i=oc-r,s=Math.min(5,oc/o),u=ic(a,e),c=i/(o-a.index+1),d=i/(o-a.index+(a.sibling?1:0))*u
n&&(l.left=a.sibling?r+c:r+s),l.width=dc(a,e,t)?oc-l.left:Math.min(oc-l.left,1.7*d)}}function ic(e,t){if(!e.children.length)return 1
const a=e.index+t.length
return e.children.reduce((e,t)=>Math.min(e,t.index),a)-e.index}function sc(e,t){const a=function(e,t){const a=[]
for(const l of t)Ju(e.start,e.end,l.start,l.end)&&a.push(l.index)
return a}(e,t)
a.sort()
for(let e=0;e<a.length;e++)if(e<a[e])return e
return!1}function uc(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4]
const o=[]
for(const n of t)n.index>=a&&n.index<=l&&Ju(e.start,e.end,n.start,n.end)&&o.push(n)
if(n&&o.length>0){const e=o.reduce((e,t)=>Math.min(e,t.index),o[0].index)
return o.filter(t=>t.index===e)}return o}function cc(e,t){let a=null
for(const l of t)Ju(e.start,e.end,l.start,l.end)&&(null===a||l.index>a.index)&&(a=l)
return a}function dc(e,t,a){for(const l of t)if(l!==e&&l.index>e.index&&Ju(e.start,mc(e.start,a),l.start,l.end))return!1
return!0}function vc(e,t){const[a,l]=lc(e.event,t)
return{parent:null,sibling:!0,index:0,visual:e,start:a,end:l,children:[]}}function pc(e){let t=e.index
for(const a of e.children){const e=pc(a)
e>t&&(t=e)}return t}function mc(e,t){const a=e%100,l=a+t
return e-a+100*Math.floor(l/60)+l%60}const fc={stack:(e,t,a)=>{const l=nc(t)
return(e,t,n,o)=>{if(!n)return l.getVisuals(e,t,n,o)
const r=Xs(e),i=Qu(t,r),s=function(e,t){const a=[]
for(const l of e){const[e,n]=lc(l.event,t)
let o=!1
for(const t of a)if(Ju(e,n,t.start,t.end)){t.visuals.push(l),t.end=Math.max(t.end,n),o=!0
break}o||a.push({start:e,end:n,visuals:[l]})}return a}(i,r)
for(const e of s){const t=[]
for(const l of e.visuals){const e=vc(l,r),n=sc(e,t)
if(!1===n){const l=cc(e,t)
l&&(e.parent=l,e.sibling=Ju(e.start,e.end,l.start,mc(l.start,a)),e.index=l.index+1,l.children.push(e))}else{const[l]=uc(e,t,n-1,n-1),o=uc(e,t,n+1,n+t.length,!0)
e.children=o,e.index=n,l&&(e.parent=l,e.sibling=Ju(e.start,e.end,l.start,mc(l.start,a)),l.children.push(e))
for(const t of o){t.parent===l&&(t.parent=e)
t.index-e.index<=1&&e.sibling&&Ju(e.start,mc(e.start,a),t.start,t.end)&&(t.sibling=!0)}}t.push(e)}rc(t,a)}return i.sort((e,t)=>e.left-t.left||e.event.startTimestampIdentifier-t.event.startTimestampIdentifier),i}},column:(e,t,a)=>{const l=nc(t)
...
function gc(e,t){return t>=e.startIdentifier&&t<=e.endIdentifier}function hc(e,t,a,l){return a===e.startIdentifier||l===t.weekday&&gc(e,a)}const yc=vt({events:{type:Array,default:()=>[]},eventStart:{type:String,default:"start"},eventEnd:{type:String,default:"end"},eventTimed:{type:[String,Function],default:"timed"},eventCategory:{type:[String,Function],default:"category"},eventHeight:{type:Number,default:20},eventColor:{type:[String,Function],default:"primary"},eventTextColor:{type:[String,Function]},eventName:{type:[String,Function],default:"name"},eventOverlapThreshold:{type:[String,Number],default:60},eventOverlapMode:{type:[String,Function],default:"stack",validate:e=>e in fc||"function"==typeof e},eventMore:{type:Boolean,default:!0},eventMoreText:{type:String,default:"$vuetify.calendar.moreEvents"},eventRipple:{type:[Boolean,Object],default:null},eventMarginBottom:{type:Number,default:1}},"VCalendar-events")
function bc(e,a,l){const n=Mu(e),o=t.computed(()=>!Array.isArray(e.events)||0===e.events.length),r=t.computed(()=>"category"===e.type),i=t.computed(()=>"function"==typeof e.eventTimed?e.eventTimed:t=>!!t[e.eventTimed]),s=t.computed(()=>"function"==typeof e.eventCategory?e.eventCategory:t=>t[e.eventCategory]),u=t.computed(()=>e.events?e.events.map((t,a)=>function(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o=arguments.length>5&&void 0!==arguments[5]&&arguments[5]
const r=e[a],i=e[l],s=Us(r,!0),u=i?Us(i,!0):s,c=Qs(r)?Js(s,n):s,d=Qs(i)?Js(u,n):u,v=Ks(c),p=Xs(c),m=Ks(d),f=c.hasTime?0:2359
return{input:e,start:c,startIdentifier:v,startTimestampIdentifier:p,end:d,endIdentifier:m,endTimestampIdentifier:Xs(d)+f,allDay:!c.hasTime,index:t,category:o}}(t,a,e.eventStart||"",e.eventEnd||"",i.value(t),!!r.value&&s.value(t))):[]),c=t.computed(()=>parseInt(String(e.eventOverlapThreshold||0))),d=t.computed(()=>"function"==typeof e.eventTextColor?e.eventTextColor:()=>e.eventTextColor),v=t.computed(()=>"function"==typeof e.eventName?e.eventName:(t,a)=>t.input[e.eventName]||""),p=t.computed(()=>"function"==typeof e.eventOverlapMode?e.eventOverlapMode:fc[e.eventOverlapMode]),m=t.computed(()=>n.effectiveWeekdays.value)
...
const n=e.eventHeight||0,o=e.eventMarginBottom||0,i=Ks(a),s=a.week,u=i===l.startIdentifier
let c=i===l.endIdentifier,d=95
if(!r.value)for(let e=a.index+1;e<s.length;e++){const t=Ks(s[e])
...
const s=Ks(a),u=l.startIdentifier>=s,c=l.endIdentifier>s,d=a.timeToY(l.start,a),v=a.timeToY(l.end,a)
...
t&&(n=n.concat(t))}return n}}}}}const Vc=wt()({name:"VCalendar",directives:{vResize:Ou},props:{modelValue:{type:[String,Number,Date],validate:Ys},categoryDays:{type:[Number,String],default:1,validate:e=>isFinite(parseInt(e))&&parseInt(e)>0},categories:{type:[Array,String],default:""},categoryText:{type:[String,Function]},maxDays:{type:Number,default:7},categoryHideDynamic:{type:Boolean},categoryShowAll:{type:Boolean},categoryForInvalid:{type:String,default:""},...Fu(),...yc()},setup(e,a){let{slots:l,attrs:n,emit:o}=a
const r=t.ref(),i=bc(e,l,n),s=t.ref(null),u=t.ref(null),c=t.computed(()=>parseInt(String(e.categoryDays))||1),d=t.computed(()=>Hu(e.categories,e.categoryText)),v=t.computed(()=>{const t=i.parsedValue.value
let a=null,l=e.maxDays,n=d.value,o=t,r=t
switch(e.type){case"month":a=Zu,o=Os(t),r=js(t)
break
case"week":a=ju,o=i.getStartOfWeek(t),r=i.getEndOfWeek(t),l=7
break
case"day":a=ju,l=1
break
case"4day":a=ju,r=cu(nu(r),su,3),au(r),l=4
break
case"custom-weekly":a=Zu,o=i.parsedStart.value||t,r=i.parsedEnd.value
break
case"custom-daily":a=ju,o=i.parsedStart.value||t,r=i.parsedEnd.value
break
case"category":const s=c.value
a=Wu,r=cu(nu(r),su,s),au(r),l=s,n=V(n)
break
...
const a=nu(i.parsedValue.value),l=t>0,n=l?su:uu,r=l?31:1
let s=l?t:-t
...
case"4day":cu(a,n,4)
break
case"category":cu(a,n,c.value)}tu(a),au(a),Zs(a,i.times.now),e.modelValue instanceof Date?o("update:modelValue",vu(a)):"number"==typeof e.modelValue?o("update:modelValue",vu(a).getTime()):o("update:modelValue",a.date),o("moved",a)}function V(t){if(!i.noEvents.value){const a=t.reduce((e,t,a)=>("object"==typeof t&&t.categoryName?e[t.categoryName]={index:a,count:0}:"string"==typeof t&&(e[t]={index:a,count:0}),e),{})
...
return t.withDirectives(t.createVNode(u,t.mergeProps({ref:r,class:["v-calendar",{"v-calendar-events":!i.noEvents.value}],role:"grid"},u.filterProps(e),{start:a.date,end:l.date,maxDays:s,weekdays:i.effectiveWeekdays.value,categories:c,"onClick:date":(e,t)=>{n["onUpdate:modelValue"]&&o("update:modelValue",t.date)}}),i.getScopedSlots()),[[Ou,i.updateEventVisibility,void 0,{quiet:!0}]])}),xo({...i,lastStart:s,lastEnd:u,parsedCategoryDays:c,renderProps:v,eventWeekdays:p,categoryMode:m,title:h,monthLongFormatter:f,monthShortFormatter:g,parsedCategories:d,checkChange:y,move:b,next:function(){b(arguments.length>0&&void 0!==arguments[0]?arguments[0]:1)},prev:function(){b(-(arguments.length>0&&void 0!==arguments[0]?arguments[0]:1))},getCategoryList:V},r)}}),wc=vt({...pt(),...Pa()},"VCardActions"),kc=wt()({name:"VCardActions",props:wc(),setup(e,a){let{slots:l}=a
return yt({VBtn:{slim:!0,variant:"text"}}),Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-actions",e.class]),style:t.normalizeStyle(e.style)},l)),{}}}),Sc=vt({opacity:[Number,String],...pt(),...Pa()},"VCardSubtitle"),xc=wt()({name:"VCardSubtitle",props:Sc(),setup(e,a){let{slots:l}=a
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-subtitle",e.class]),style:t.normalizeStyle([{"--v-card-subtitle-opacity":e.opacity},e.style])},l)),{}}}),Nc=kt("v-card-title"),Cc=vt({appendAvatar:String,appendIcon:Dt,prependAvatar:String,prependIcon:Dt,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...pt(),...Ml(),...Pa()},"VCardItem"),Ec=wt()({name:"VCardItem",props:Cc(),setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:t.normalizeClass(["v-card-item",e.class]),style:t.normalizeStyle(e.style)},{default:()=>[n&&t.createElementVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(ol,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Zn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(nn,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createElementVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(Nc,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(xc,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createElementVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(ol,{key:"append-defaults",disabled:!o,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(nn,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Zn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]})}),{}}}),Ic=vt({opacity:[Number,String],...pt(),...Pa()},"VCardText"),_c=wt()({name:"VCardText",props:Ic(),setup(e,a){let{slots:l}=a
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-text",e.class]),style:t.normalizeStyle([{"--v-card-text-opacity":e.opacity},e.style])},l)),{}}}),Pc=vt({appendAvatar:String,appendIcon:Dt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Dt,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...Sl(),...pt(),...Ml(),...rl(),...Nl(),...pn(),...Il(),...hn(),...ml(),...wn(),...Pa(),...ya(),...jl({variant:"elevated"})},"VCard"),Ac=wt()({name:"VCard",directives:{vRipple:Mn},props:Pc(),setup(e,a){let{attrs:l,slots:n}=a
...
return t.withDirectives(t.createVNode(V,t.mergeProps(h.linkProps,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":l},o.value,r.value,i.value,c.value,v.value,p.value,f.value,g.value,u.value,e.class],style:[s.value,d.value,m.value,{"--v-card-height":b(e.height)},e.style],onClick:l&&h.navigate.value,tabindex:e.disabled?-1:void 0}),{default:()=>[C&&t.createElementVNode("div",{key:"image",class:"v-card__image"},[n.image?t.createVNode(ol,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},n.image):t.createVNode(kl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(fn,{name:"v-card",active:!!e.loading,color:y.value},{default:n.loader}),E&&t.createVNode(Ec,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:n.item,prepend:n.prepend,title:n.title,subtitle:n.subtitle,append:n.append}),I&&t.createVNode(_c,{key:"text"},{default:()=>[n.text?.()??e.text]}),n.default?.(),n.actions&&t.createVNode(kc,null,{default:n.actions}),Ol(l,"v-card")]}),[[Mn,l&&e.ripple]])}),{}}})
function Rc(e,t){const a=e.changedTouches[0]
...
e.offsetX=a-t,e.offsetY=n-l,Math.abs(e.offsetY)<.5*Math.abs(e.offsetX)&&(e.left&&a<t-16&&e.left(e),e.right&&a>t+16&&e.right(e)),Math.abs(e.offsetX)<.5*Math.abs(e.offsetY)&&(e.up&&n<l-16&&e.up(e),e.down&&n>l+16&&e.down(e))})(t)}const Tc={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,n=a?.options??{passive:!0},o=t.instance?.$.uid
...
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}(e,t),touchend:e=>Rc(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
...
x(n).forEach(e=>{a.removeEventListener(e,n[e])}),delete a._touchHandlers[l]}},Bc=Symbol.for("vuetify:v-window"),Dc=Symbol.for("vuetify:v-window-group"),$c=vt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},verticalArrows:[Boolean,String],touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},crossfade:Boolean,transitionDuration:Number,...pt(),...Pa(),...ya()},"VWindow"),Fc=wt()({name:"VWindow",directives:{vTouch:Tc},props:$c(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{isRtl:r}=ga(),{t:i}=ma(),s=ql(e,Dc),u=t.ref(),d=t.computed(()=>r.value?!e.reverse:e.reverse),v=t.shallowRef(!1),p=t.computed(()=>{if(e.crossfade)return"v-window-crossfade-transition"
...
l.scrollTop!==n.top&&l.scrollTo({...n,behavior:"instant"})})})},{flush:"sync"}),t.provide(Bc,{transition:p,isReversed:v,transitionCount:m,transitionHeight:f,rootRef:u})
...
return l.item?l.item({props:n,item:e}):t.createVNode(Ln,t.mergeProps(e,n),null)})]})]),e.progress&&t.createVNode(vn,{absolute:!0,class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(n.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})}),{}}}),Lc=vt({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...pt(),...Gl(),...bi()},"VWindowItem"),Oc=wt()({name:"VWindowItem",directives:{vTouch:Tc},props:Lc(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const n=t.inject(Bc),o=Kl(e,Dc),{isBooted:r}=Bl()
...
n.value=!0
const t=function(e){return"touches"in e?{clientX:e.touches[0].clientX,clientY:e.touches[0].clientY}:{clientX:e.clientX,clientY:e.clientY}}(e),a=Se([t.clientX,t.clientY])
!function(e,t,a){const{left:l,top:n,width:o,height:r}=a
c.value={x:$(e-l,0,o),y:$(t-n,0,r)}}(a.x,a.y,Se(o.value))}function f(){window.removeEventListener("mousemove",m),window.removeEventListener("mouseup",f),window.removeEventListener("touchmove",m),window.removeEventListener("touchend",f)}function g(){if(!o.value)return
...
const Uc={h:0,s:0,v:0,a:1},Gc={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)}),localeKey:"redInput"},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)}),localeKey:"greenInput"},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)}),localeKey:"blueInput"},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Xe,from:Qe},Kc={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)}),localeKey:"hueInput"},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)}),localeKey:"saturationInput"},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)}),localeKey:"lightnessInput"},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Je,from:et},qc={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t,localeKey:"hexaInput"}],to:rt,from:function(e){return Qe(ot(e))}},Xc={rgb:{...Gc,inputs:Gc.inputs?.slice(0,3)},rgba:Gc,hsl:{...Kc,inputs:Kc.inputs.slice(0,3)},hsla:Kc,hex:{...qc,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t,localeKey:"hexInput"}]},hexa:qc},Zc=e=>{let{label:a,...l}=e
return t.createElementVNode("div",{class:"v-color-picker-edit__input"},[t.createElementVNode("input",t.normalizeProps(t.guardReactiveProps(l)),null),t.createElementVNode("span",null,[a])])},Qc=Vt({name:"VColorPickerEdit",props:vt({color:Object,disabled:Boolean,readonly:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Xc).includes(e)},modes:{type:Array,default:()=>Object.keys(Xc),validator:e=>Array.isArray(e)&&e.every(e=>Object.keys(Xc).includes(e))},...pt()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
const{t:n}=ma(),o=t.computed(()=>e.modes.map(e=>({...Xc[e],name:e}))),r=t.computed(()=>{const t=o.value.find(t=>t.name===e.mode)
if(!t)return[]
...
n&&l("update:color",t.from(i(a??t.to(Uc),n.value)))}}})})
return Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-edit",e.class]),style:t.normalizeStyle(e.style)},[r.value?.map(e=>t.createVNode(Zc,e,null)),o.value.length>1&&t.createVNode(Ln,{icon:"$unfold",size:"x-small",variant:"plain","aria-label":n("$vuetify.colorPicker.ariaLabel.changeFormat"),onClick:()=>{const t=o.value.findIndex(t=>t.name===e.mode)
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)])),{}}}),Jc=Symbol.for("vuetify:v-slider")
function ed(e,t,a){const l="vertical"===a,n=t.getBoundingClientRect(),o="touches"in e?e.touches[0]:e
return l?o.clientY-(n.top+n.height/2):o.clientX-(n.left+n.width/2)}const td=vt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e||"hover"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,noKeyboard:Boolean,...ml(),...Nl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),ad=e=>{const a=t.computed(()=>parseFloat(e.min)),l=t.computed(()=>parseFloat(e.max)),n=t.computed(()=>Number(e.step)>0?parseFloat(e.step):0),o=t.computed(()=>Math.max(F(n.value),F(a.value)))
...
return t>i&&i+n.value>l.value&&(i=l.value),parseFloat(Math.min(i,l.value).toFixed(o.value))}}},ld=e=>{let{props:a,steps:l,onSliderStart:n,onSliderMove:o,onSliderEnd:r,getActiveThumb:i}=e
...
P.value=i(e),P.value&&(E.value=!0,P.value.contains(e.target)?I.value=ed(e,P.value,a.direction):(I.value=0,null!=l&&o({value:l})),null!=l&&n({value:l}),t.nextTick(()=>P.value?.focus()))},B={passive:!0,capture:!0}
...
return t.provide(Jc,H),H},nd=vt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,noKeyboard:Boolean,...pt()},"VSliderThumb"),od=wt()({name:"VSliderThumb",directives:{vRipple:Mn},props:nd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:n}=a
const o=t.inject(Jc),{isRtl:r,rtlClasses:i}=ga()
...
return t.createElementVNode("div",{class:"v-slider__container",onMousedown:w.value?void 0:f,onTouchstartPassive:w.value?void 0:g},[t.createElementVNode("input",{id:n.value,name:e.name||n.value,disabled:V.value,readonly:w.value,tabindex:"-1",value:c.value},null),t.createVNode(id,{ref:h,start:0,stop:C.value},{"tick-label":l["tick-label"]}),t.createVNode(od,t.mergeProps({ref:r,"aria-describedby":o.value,focused:S.value,noKeyboard:k.value,min:d.value,max:v.value,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,position:C.value,elevation:e.elevation,onFocus:x,onBlur:N,ripple:e.ripple,name:e.name},u),{"thumb-label":l["thumb-label"]})])}})}),xo({focus:()=>r.value?.$el.focus()},i)}}),cd=vt({color:{type:Object},disabled:Boolean,readonly:Boolean,hideAlpha:Boolean,hideEyeDropper:Boolean,eyeDropperIcon:{type:Dt,default:"$eyeDropper"},...pt()},"VColorPickerPreview"),dd=Vt({name:"VColorPickerPreview",props:cd(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
l("update:color",{...e.color??Uc,...a})}catch(e){}}return t.onUnmounted(()=>o.abort()),Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class]),style:t.normalizeStyle(e.style)},[s&&!e.hideEyeDropper&&t.createElementVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Ln,{"aria-label":n("$vuetify.colorPicker.ariaLabel.eyedropper"),density:"comfortable",disabled:e.disabled,readonly:e.readonly,icon:e.eyeDropperIcon,variant:"plain",onClick:i},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__dot"},[t.createElementVNode("div",{style:{background:at(e.color??Uc)}},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(ud,{class:"v-color-picker-preview__track v-color-picker-preview__hue","aria-label":n("$vuetify.colorPicker.ariaLabel.hueSlider"),modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Uc,h:t}),step:1,min:0,max:360,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(ud,{class:"v-color-picker-preview__track v-color-picker-preview__alpha","aria-label":n("$vuetify.colorPicker.ariaLabel.alphaSlider"),modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Uc,a:t}),step:.01,min:0,max:1,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])])),{}}})
var vd={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const pd=vt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map(t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]})}(vd)},disabled:Boolean,readonly:Boolean,color:Object,maxHeight:[Number,String],...pt()},"VColorPickerSwatches")
const md=Vt({name:"VColorPickerSwatches",props:pd(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return t.onBeforeMount(()=>{e.modes.includes(o.value)||(o.value=e.modes[0])}),yt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Bt(()=>{const a=hd.filterProps(e)
return t.createVNode(hd,t.mergeProps(a,{class:["v-color-picker",u.value,e.class],style:[{"--v-color-picker-color-hsv":at({...s.value??Uc,a:1})},e.style]}),{...n,default:()=>t.createElementVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(Yc,{key:"canvas",color:s.value,"onUpdate:color":d,disabled:e.disabled,readonly:e.readonly,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createElementVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(dd,{key:"preview",color:s.value,"onUpdate:color":d,hideAlpha:!o.value.endsWith("a"),disabled:e.disabled,readonly:e.readonly,hideEyeDropper:e.hideEyeDropper,eyeDropperIcon:e.eyeDropperIcon},null),!e.hideInputs&&t.createVNode(Qc,{key:"edit",modes:e.modes,mode:o.value,"onUpdate:mode":e=>o.value=e,color:s.value,"onUpdate:color":d,disabled:e.disabled,readonly:e.readonly},null)]),e.showSwatches&&t.createVNode(md,{key:"swatches",color:s.value,"onUpdate:color":d,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled,readonly:e.readonly},null)])})}),{}}}),bd=vt({alwaysFilter:Boolean,autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...rs({filterKeys:["title"]}),...ds({hideNoData:!0,returnObject:!0}),...I(Gi({modelValue:null,role:"combobox"}),["validationValue","dirty"])},"VCombobox"),Vd=wt()({name:"VCombobox",props:bd(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return e.multiple?a:a[0]??null}),k=go(e),S=t.toRef(()=>e.closableChips&&!k.isReadonly.value&&!k.isDisabled.value),x=t.computed(()=>!(!e.chips&&!n.chip)),N=t.computed(()=>x.value||!!n.selection),C=t.shallowRef(e.multiple||N.value?"":w.value[0]?.title??""),E=t.shallowRef(null),I=t.computed({get:()=>C.value,set:async a=>{if(C.value=a??"",null===a||""===a&&!e.multiple&&!N.value?w.value=[]:e.multiple||N.value||(w.value=[Tr(e,a)],t.nextTick(()=>v.value?.scrollToIndex(0))),a&&e.multiple&&e.delimiters?.length){const e=ie(a)
e.length>1&&(se(e),C.value="")}a||(p.value=-1),u.value=!a}}),_=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(w.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?w.value.length:I.value.length),{filteredItems:P,getMatches:A}=is(e,f,()=>E.value??(e.alwaysFilter||!u.value?I.value:"")),T=t.computed(()=>e.hideSelected&&null===E.value?P.value.filter(e=>!w.value.some(t=>t.value===e.value)):P.value),D=t.computed(()=>e.hideNoData&&!T.value.length||k.isReadonly.value||k.isDisabled.value),$=la(e,"menu"),F=t.computed({get:()=>$.value,set:e=>{$.value&&!e&&d.value?.ΨopenChildren.size||e&&D.value||($.value=e)}}),{menuId:M,ariaExpanded:z,ariaControls:L}=cs(0,F)
...
const O=t.computed(()=>w.value.map(e=>e.value)),j=t.computed(()=>T.value.find(e=>"item"===e.type&&!e.props.disabled)),H=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&I.value===j.value?.title)&&T.value.length>0&&!u.value&&!c.value),W=t.ref(),Y=t.ref(),U=t.ref(),G=as(W,i),K=ts(F,()=>d.value?.contentEl,()=>i.value?.controlRef),{onTabKeydown:q}=ls({groups:[{type:"element",contentRef:Y},{type:"list",contentRef:W,displayItemsCount:()=>T.value.length},{type:"element",contentRef:U}],onLeave:()=>{F.value=!1,i.value?.focus()}})
function X(a){m=!0,t.nextTick(()=>m=!1),e.openOnClear&&(F.value=!0)}function Z(){D.value||(F.value=!0)}function Q(e){D.value||(s.value&&(e.preventDefault(),e.stopPropagation()),F.value=!F.value)}function J(e){"Tab"===e.key&&q(e),W.value?.$el.contains(e.target)&&(ue(e)||"Backspace"===e.key)&&i.value?.focus()}function ee(t){if(function(e){return e.isComposing&&R.includes(e.key)}(t)||k.isReadonly.value)return
...
return t===j.value.value})&&oe(j.value),"ArrowDown"===t.key&&H.value&&W.value?.focus("next"),"Enter"===t.key&&I.value&&(oe(Tr(e,I.value),!0,!0),N.value&&(C.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&N.value&&w.value.length>0&&!I.value)return oe(w.value[0],!1)
if(~p.value){t.preventDefault()
const e=p.value
oe(w.value[p.value],!1),p.value=e>=l-1?l-2:e}else"Backspace"!==t.key||I.value||(p.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(p.value<0&&a&&a>0)return
...
const e=p.value+1
w.value[e]?p.value=e:(p.value=-1,i.value?.setSelectionRange(0,0))}else~p.value&&ue(t)&&(p.value=-1)}function te(t){const a=ie(t?.clipboardData?.getData("Text")??"")
a.length>1&&e.multiple&&(t.preventDefault(),se(a))}function ae(){e.eager&&v.value?.calculateVisibleItems()}function le(){s.value&&i.value?.focus(),u.value=!0,E.value=null}function oe(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=arguments.length>2&&void 0!==arguments[2]&&arguments[2]
if(a&&!a.props.disabled)if(e.multiple){const t=w.value.findIndex(t=>(e.valueComparator||St)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...w.value,a]:[...w.value]
e.splice(t,1),w.value=e}else n&&(w.value=[...w.value,a])
e.clearOnSelect&&(I.value="")}else{const o=!1!==l
w.value=o?[a]:[],u.value&&!e.alwaysFilter||!C.value||(E.value=C.value),C.value=o&&!N.value?a.title:"",t.nextTick(()=>{F.value=n,u.value=!0})}}function ie(t){const a=["\n",...e.delimiters??[]].map(de).join("|")
return t.split(new RegExp(`(?:${a})+`))}async function se(a){for(let l of a)l=l.trim(),l&&(oe(Tr(e,l)),await t.nextTick())}function ce(e){s.value=!0,setTimeout(()=>{c.value=!0})}function ve(e){if(c.value=!1,!i.value?.$el.contains(e.relatedTarget)){if(K(e))return
s.value=!1}}function pe(e){const t=d.value?.contentEl
t?.contains(e.relatedTarget)&&(s.value=!0)}return t.watch(s,(t,a)=>{if(!t&&t!==a&&(p.value=-1,F.value=!1,I.value)){if(e.multiple)return void oe(Tr(e,I.value))
if(!N.value)return
w.value.some(e=>{let{title:t}=e
return t===I.value})?C.value="":oe(Tr(e,I.value))}}),t.watch(F,t=>{if(!e.hideSelected&&t&&w.value.length&&u.value){const t=T.value.findIndex(t=>w.value.some(a=>(e.valueComparator||St)(a.value,t.value)))
...
return t.createVNode(Ki,t.mergeProps({ref:i},o,{modelValue:I.value,"onUpdate:modelValue":e=>I.value=e,focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:w.externalValue,counterValue:_.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":F.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!N.value,"v-combobox--selecting-index":p.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:k.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":X,"onMousedown:control":Z,onKeydown:ee,onPaste:te,onBlur:pe,"aria-expanded":z.value,"aria-controls":L.value}),{...n,default:l=>{let{id:o}=l
return t.createElementVNode(t.Fragment,null,[t.createVNode(Ti,t.mergeProps({id:M.value,ref:d,modelValue:F.value,"onUpdate:modelValue":e=>F.value=e,activator:"parent",disabled:D.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,onAfterEnter:ae,onAfterLeave:le},e.menuProps,{contentClass:["v-combobox__content",e.menuProps?.contentClass]}),{default:()=>[t.createVNode(Di,{onFocusin:ce,onKeydown:J},{default:()=>[n["menu-header"]&&t.createElementVNode("header",{ref:Y},[n["menu-header"](c)]),a&&t.createVNode(Or,t.mergeProps({key:"combobox-list",ref:W,filterable:!0,selected:O.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),selectable:!!T.value.length,onFocusout:ve,tabindex:"-1","aria-live":"polite","aria-labelledby":`${o.value}-label`,"aria-multiselectable":e.multiple,color:e.itemColor??e.color},G,e.listProps),{default:()=>[n["prepend-item"]?.(),!T.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(Cr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(es,{ref:v,renderless:!0,items:T.value,itemKey:"value"},{default:a=>{let{item:l,index:o,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!H.value||l!==j.value)||void 0,onClick:()=>oe(l,null),"aria-posinset":o+1,"aria-setsize":T.value.length})
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(io,{key:l.value,modelValue:n,ripple:!1,tabindex:"-1","aria-hidden":!0,onClick:e=>e.preventDefault()},null):void 0,l.props.prependAvatar&&t.createVNode(Zn,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(nn,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:ss("v-combobox",l.title,A(l)?.title)})}}),n["append-item"]?.()]}),n["menu-footer"]&&t.createElementVNode("footer",{ref:U},[n["menu-footer"](c)])]})]}),w.value.map((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),oe(a,!1)}const r=t.mergeProps(Jo.filterProps(a.props),{"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0}),i=x.value?!!n.chip:!!n.selection,s=i?re(x.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
...
return t.createElementVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(nn,{class:"v-combobox__menu-icon",color:i.value?.fieldIconColor,icon:e.menuIcon,onMousedown:Q,onClick:ne,"aria-hidden":!0,tabindex:"-1"},null),e.appendInnerIcon&&t.createVNode(V,{key:"append-icon",name:"appendInner",color:l[0].iconColor.value},null)])}})}),xo({isFocused:s,isPristine:u,menu:F,search:I,selectionIndex:p,filteredItems:P,select:oe},i)}}),wd=vt({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"},disabled:{type:[Boolean,Array],default:void 0},hideActions:Boolean},"VConfirmEdit"),kd=wt()({name:"VConfirmEdit",props:wd(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return Bt(()=>t.createElementVNode(t.Fragment,null,[n.default?.({model:r,save:v,cancel:p,isPristine:s.value,get actions(){return f=!0,m}}),!e.hideActions&&!f&&m()])),{save:v,cancel:p,isPristine:s}}}),Sd=vt({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),xd=Symbol.for("vuetify:datatable:expanded")
function Nd(e){const a=t.toRef(()=>e.expandOnClick),l=la(e,"expanded",e.expanded,e=>new Set(e),e=>[...e.values()])
...
return t.provide(xd,r),r}function Cd(){const e=t.inject(xd)
if(!e)throw new Error("foo")
return e}const Ed=vt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Id=Symbol.for("vuetify:data-table-group")
function _d(e){return{groupBy:la(e,"groupBy")}}function Pd(e){const{disableSort:a,groupBy:l,sortBy:n}=e,o=t.ref(new Set)
...
return t.provide(Id,i),i}function Ad(){const e=t.inject(Id)
if(!e)throw new Error("Missing group!")
return e}function Rd(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
...
o.push({depth:a,id:s,key:i,value:n,items:r.length?Rd(e,r,a+1,s):e,type:"group"})}),o}function Td(e,t,a){const l=[]
for(const n of e)"type"in n&&"group"===n.type?(null!=n.value&&l.push(n),(t.has(n.id)||null==n.value)&&(l.push(...Td(n.items,t,a)),a&&l.push({...n,type:"group-summary"}))):l.push(n)
return l}function Bd(e,a,l,n){const o=t.computed(()=>a.value.length?Rd(t.toValue(e),a.value.map(e=>e.key)):[]),r=t.computed(()=>a.value.length?Td(o.value,l.value,t.toValue(n)):t.toValue(e))
return{groups:o,flatItems:r}}function Dd(e){let{page:a,itemsPerPage:l,sortBy:n,groupBy:o,search:r}=e
const i=mt("VDataTable")
let s=null
t.watch(()=>({page:a.value,itemsPerPage:l.value,sortBy:n.value,groupBy:o.value,search:r.value}),e=>{St(s,e)||(s&&s.search!==e.search&&(a.value=1),i.emit("update:options",e),s=e)},{deep:!0,immediate:!0})}const $d=vt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10},pageBy:{type:String,default:"any"}},"DataTable-paginate"),Fd=Symbol.for("vuetify:data-table-pagination")
function Md(e){return{page:la(e,"page",void 0,e=>Number(e??1)),itemsPerPage:la(e,"itemsPerPage",void 0,e=>Number(e??10))}}function zd(e){const{page:a,itemsPerPage:l,itemsLength:n}=e,o=t.computed(()=>-1===l.value?0:l.value*(a.value-1)),r=t.computed(()=>-1===l.value?n.value:Math.min(n.value,o.value+l.value)),i=t.computed(()=>-1===l.value||0===n.value?1:Math.ceil(n.value/l.value))
...
return t.provide(Fd,s),s}function Ld(e){const a=mt("usePaginatedItems"),{items:l,startIndex:n,stopIndex:o,itemsPerPage:r}=e,i=t.computed(()=>r.value<=0?t.toValue(l):t.toValue(l).slice(n.value,o.value))
return t.watch(i,e=>{a.emit("update:currentItems",e)},{immediate:!0}),{paginatedItems:i}}const Od={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},jd={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return jd.select({items:a,value:t,selected:l})}},Hd={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a}=e
return new Set(t?a.map(e=>e.value):[])}},Wd=vt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:Function},"DataTable-select"),Yd=Symbol.for("vuetify:data-table-selection")
function Ud(e,a){let{allItems:l,currentPage:n}=a
...
switch(e.selectStrategy){case"single":return Od
case"all":return Hd
default:return jd}}),u=t.shallowRef(null)
...
return t.provide(Yd,m),m}function Gd(){const e=t.inject(Yd)
if(!e)throw new Error("Missing selection!")
return e}const Kd=vt({initialSortOrder:{type:String,default:"asc",validator:e=>!e||["asc","desc"].includes(e)},sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:{type:[Boolean,Object],default:!1},mustSort:Boolean},"DataTable-sort"),qd=Symbol.for("vuetify:data-table-sort")
function Xd(e){const a=t.toRef(()=>e.initialSortOrder),l=la(e,"sortBy"),n=t.toRef(()=>e.mustSort)
return{initialSortOrder:a,sortBy:l,multiSort:t.toRef(()=>e.multiSort),mustSort:n}}function Zd(e){const{initialSortOrder:a,sortBy:l,mustSort:n,multiSort:o,page:r}=e
...
return t.provide(qd,i),i}function Qd(){const e=t.inject(qd)
if(!e)throw new Error("Missing sort!")
return e}function Jd(e,a,l,n){const o=ma(),r=t.computed(()=>l.value.length?function(e,t,a,l){const n=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),o=e.map(e=>[e,l?.transform?l.transform(e):e])
...
return{sortedItems:r}}const ev=vt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function tv(e,t){return{type:"item",value:e.returnObject?t:h(t,e.itemValue),selectable:h(t,e.itemSelectable,!0),raw:t}}function av(e){const a=t.computed(()=>function(e,t){const a=[]
for(const l of t)a.push(tv(e,l))
return a}(e,e.items))
return{items:a}}const lv=vt({search:String,loading:Boolean,itemsLength:[Number,String],...pt(),...ev(),...Wd(),...Kd(),...$d({itemsPerPage:5}),...Sd(),...Ed(),...rs(),...Pa(),...gl({transition:{component:Ya,hideOnLeave:!0}})},"VDataIterator"),nv=wt()({name:"VDataIterator",props:lv(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"groupBy"),o=t.toRef(()=>e.search),{items:r}=av(e),{filteredItems:i}=is(e,r,o,{transform:e=>e.raw}),{initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d}=Xd(e),{page:v,itemsPerPage:p}=Md(e),{toggleSort:m}=Zd({initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d,page:v}),{sortByWithGroups:f,opened:g,extractRows:h,isGroupOpen:y,toggleGroup:b}=Pd({groupBy:n,sortBy:u}),{sortedItems:V}=Jd(e,i,f,{transform:e=>e.raw}),{flatItems:w}=Bd(V,n,g,!1),k=t.toRef(()=>!le(e.itemsLength)),S=t.toRef(()=>k.value?Number(e.itemsLength):w.value.length),{startIndex:x,stopIndex:N,pageCount:C,prevPage:E,nextPage:I,setItemsPerPage:_,setPage:P}=zd({page:v,itemsPerPage:p,itemsLength:S}),A=t.shallowRef([]),R=t.computed(()=>k.value?w.value:A.value)
aa(()=>!k.value,()=>{const{paginatedItems:e}=Ld({items:w,startIndex:x,stopIndex:N,itemsPerPage:p})
t.watchEffect(()=>{A.value=e.value})})
const T=t.computed(()=>h(R.value)),{isSelected:B,select:D,selectAll:$,toggleSelect:F}=Ud(e,{allItems:r,currentPage:T}),{isExpanded:M,toggleExpand:z}=Nd(e)
Dd({page:v,itemsPerPage:p,sortBy:u,groupBy:n,search:o})
...
return Bt(()=>{const a=rv.filterProps(e)
return t.createElementVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createElementVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createElementVNode("span",null,[n(e.itemsPerPageText)]),t.createVNode(ps,{items:v.value,itemColor:e.color,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined","aria-label":n(e.itemsPerPageText),hideDetails:!0},null)]),t.createElementVNode("div",{class:"v-data-table-footer__info"},[t.createElementVNode("div",null,[n(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createElementVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(rv,t.mergeProps({modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,density:"comfortable",firstAriaLabel:e.firstPageLabel,lastAriaLabel:e.lastPageLabel,length:r.value,nextAriaLabel:e.nextPageLabel,previousAriaLabel:e.prevPageLabel,rounded:!0,showFirstLastPage:!0,totalVisible:e.showCurrentPage?1:0,variant:"plain"},I(a,["color"])),null)])])}),{}}}),uv=(cv={align:{type:String,default:"start"},fixed:{type:[Boolean,String],default:!1},fixedOffset:[Number,String],fixedEndOffset:[Number,String],height:[Number,String],lastFixed:Boolean,firstFixedEnd:Boolean,noPadding:Boolean,indent:[Number,String],empty:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},dv=(e,a)=>{let{slots:l}=a
const n=e.tag??"td",o="string"==typeof e.fixed?e.fixed:e.fixed?"start":"none"
return t.createVNode(n,{class:t.normalizeClass(["v-data-table__td",{"v-data-table-column--fixed":"start"===o,"v-data-table-column--fixed-end":"end"===o,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--first-fixed-end":e.firstFixedEnd,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap,"v-data-table-column--empty":e.empty},`v-data-table-column--align-${e.align}`]),style:{height:b(e.height),width:b(e.width),maxWidth:b(e.maxWidth),left:"start"===o?b(e.fixedOffset||null):void 0,right:"end"===o?b(e.fixedEndOffset||null):void 0,paddingInlineStart:e.indent?b(e.indent):void 0}},{default:()=>[l.default?.()]})},dv.props=cv,dv)
var cv,dv
const vv=vt({headers:Array},"DataTable-header"),pv=Symbol.for("vuetify:data-table-headers"),mv={title:"",sortable:!1},fv={...mv,width:48}
function gv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e.children)for(const a of e.children)gv(a,t)
else t.push(e)
return t}function hv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Set
for(const a of e)a.key&&t.add(a.key),a.children&&hv(a.children,t)
return t}function yv(e){if(e.key)return"data-table-group"===e.key?mv:["data-table-expand","data-table-select"].includes(e.key)?fv:void 0}function bv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
return e.children?Math.max(t,...e.children.map(e=>bv(e,t+1))):t}function Vv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
if(!e)return t
...
return t}function wv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
if(!e)return t
...
return t}function kv(e,t){const a=[]
let l=0
...
const o=[]
let r=1
for(;e>0;){const{element:a,priority:i}=n.dequeue(),s=t-l-bv(a)
if(o.push({...a,rowspan:s??1,colspan:a.children?gv(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
n.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(o)}return{columns:e.map(e=>gv(e)).flat(),headers:a}}function Sv(e){const t=[]
for(const a of e){const e={...yv(a),...a},l=e.key??("string"==typeof e.value?e.value:null),n=e.value??l??null,o={...e,key:l,value:n,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?Sv(e.children):void 0}
t.push(o)}return t}function xv(e,a){const n=t.ref([]),o=t.ref([]),r=t.ref({}),i=t.ref({}),s=t.ref({})
t.watchEffect(()=>{const u=(e.headers||Object.keys(e.items[0]??{}).map(e=>({key:e,title:t.capitalize(e)}))).slice(),c=hv(u)
...
const v=Math.max(...d.map(e=>bv(e)))+1,p=kv(d,v)
...
return t.provide(pv,u),u}function Nv(){const e=t.inject(pv)
if(!e)throw new Error("Missing headers!")
return e}const Cv=vt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,initialSortOrder:String,sortIcon:{type:Dt},sortAscIcon:{type:Dt,default:"$sortAsc"},sortDescIcon:{type:Dt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Ml(),...Bo(),...pn()},"VDataTableHeaders"),Ev=wt()({name:"VDataTableHeaders",props:Cv(),setup(e,a){let{slots:l}=a
const{t:n}=ma(),{toggleSort:o,sortBy:r,isSorted:i}=Qd(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=Gd(),{columns:v,headers:p}=Nv(),{loaderClasses:m}=mn(e)
...
return t.createVNode(uv,t.mergeProps({tag:"th",class:[...S.value],colspan:p.value.length+1},e.headerProps),{default:()=>[t.createElementVNode("div",{class:"v-data-table-header__content"},[t.createVNode(ps,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,chips:!0,color:e.color,class:"v-data-table__td-sort-select",clearable:!0,density:"default",items:a.value,label:n("$vuetify.dataTable.sortBy"),multiple:e.multiSort,variant:"underlined",returnObject:!0,"onClick:clear":()=>r.value=[]},{append:l?()=>t.createVNode(io,{color:e.color,density:"compact",modelValue:u.value,indeterminate:s.value&&!u.value,"onUpdate:modelValue":()=>c(!u.value)},null):void 0,chip:e=>{let{item:a}=e
...
Bt(()=>w.value?t.createElementVNode("tr",null,[t.createVNode(N,null,null)]):t.createElementVNode(t.Fragment,null,[l.headers?l.headers(k.value):p.value.map((e,a)=>t.createElementVNode("tr",null,[e.map((e,l)=>t.createVNode(x,{column:e,x:l,y:a},null))])),e.loading&&t.createElementVNode("tr",{class:"v-data-table-progress"},[t.createElementVNode("th",{colspan:v.value.length},[t.createVNode(fn,{name:"v-data-table-progress",absolute:!0,active:!0,color:"boolean"==typeof e.loading||"true"===e.loading?e.color:e.loading,indeterminate:!0},{default:l.loader})])])]))}}),Iv=vt({item:{type:Object,required:!0},groupCollapseIcon:{type:Dt,default:"$tableGroupCollapse"},groupExpandIcon:{type:Dt,default:"$tableGroupExpand"},...Ml()},"VDataTableGroupHeaderRow"),_v=wt()({name:"VDataTableGroupHeaderRow",props:Iv(),setup(e,a){let{slots:l}=a
const{isGroupOpen:n,toggleGroup:o,extractRows:r}=Ad(),{isSelected:i,isSomeSelected:s,select:u}=Gd(),{columns:c}=Nv(),d=t.computed(()=>r([e.item])),v=t.toRef(()=>c.value.length-(c.value.some(e=>"data-table-select"===e.key)?1:0))
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(uv,{class:"v-data-table-group-header-row__column",colspan:v.value},{default:()=>[t.createVNode(Ln,{size:"small",variant:"text",icon:a,onClick:r},null),t.createElementVNode("span",null,[e.item.value]),t.createElementVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const a=d.value.filter(e=>e.selectable),n=a.length>0&&i(a),o=s(a)&&!n,r=e=>u(a,e)
return l["data-table-select"]?.({props:{modelValue:n,indeterminate:o,"onUpdate:modelValue":r}})??t.createVNode(uv,{class:"v-data-table__td--select-row",noPadding:!0},{default:()=>[t.createVNode(io,{density:e.density,disabled:0===a.length,modelValue:n,indeterminate:o,"onUpdate:modelValue":r},null)]})}return""})])}}),Pv=vt({color:String,index:Number,item:Object,cellProps:[Object,Function],collapseIcon:{type:Dt,default:"$collapse"},expandIcon:{type:Dt,default:"$expand"},onClick:Z(),onContextmenu:Z(),onDblclick:Z(),...Ml(),...Bo()},"VDataTableRow"),Av=wt()({name:"VDataTableRow",props:Pv(),setup(e,a){let{slots:l}=a
const{displayClasses:n,mobile:o}=Do(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=Gd(),{isExpanded:d,toggleExpand:v}=Cd(),{toggleSort:p,sortBy:m,isSorted:f}=Qd(),{columns:h}=Nv()
...
return o.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??n])]):n}})})]))}}),Rv=vt({color:String,loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...C(Pv(),["collapseIcon","expandIcon","density"]),...C(Iv(),["groupCollapseIcon","groupExpandIcon","density"]),...Bo()},"VDataTableRows"),Tv=wt()({name:"VDataTableRows",inheritAttrs:!1,props:Rv(),setup(e,a){let{attrs:l,slots:n}=a
const{columns:o}=Nv(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=Cd(),{isSelected:u,toggleSelect:c}=Gd(),{toggleGroup:d,isGroupOpen:v}=Ad(),{t:p}=ma(),{mobile:m}=Do(e)
...
return n["group-header"]?n["group-header"](e):t.createVNode(_v,t.mergeProps({key:`group-header_${p.id}`,item:p},_t(l,":groupHeader",()=>e),a),n)}if("group-summary"===p.type){const e={index:f,item:p,columns:o.value,toggleGroup:d}
...
return t.createElementVNode(t.Fragment,{key:h.props.key},[n.item?n.item(h):t.createVNode(Av,h.props,n),s(p)&&n["expanded-row"]?.(g)])})]):t.createElementVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createElementVNode("td",{colspan:o.value.length},[n["no-data"]?.()??p(e.noDataText)])]):t.createElementVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createElementVNode("td",{colspan:o.value.length},[n.loading?.()??p(e.loadingText)])])}),{}}}),Bv=vt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,striped:{type:String,default:null,validator:e=>["even","odd"].includes(e)},...pt(),...Ml(),...Pa(),...ya()},"VTable"),Dv=wt()({name:"VTable",props:Bv(),setup(e,a){let{slots:l,emit:n}=a
const{themeClasses:o}=Ca(e),{densityClasses:r}=zl(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover,"v-table--striped-even":"even"===e.striped,"v-table--striped-odd":"odd"===e.striped},o.value,r.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.top?.(),l.default?t.createElementVNode("div",{class:"v-table__wrapper",style:{height:b(e.height)}},[t.createElementVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]})),{}}}),$v=vt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
function Fv(e,t,a){return t.map((t,l)=>function(e,t,a,l){const n=e.returnObject?t:h(t,e.itemValue),o=h(t,e.itemSelectable,!0),r=l.reduce((e,a)=>(null!=a.key&&(e[a.key]=h(t,a.value)),e),{})
return{type:"item",key:e.returnObject?h(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function Mv(e,a){return{items:t.computed(()=>Fv(e,e.items,a.value))}}const zv=vt({...Rv(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Sd(),...Ed(),...vv(),...$v(),...Wd(),...Kd(),...I(Cv(),["multiSort","initialSortOrder"]),...Bv()},"DataTable"),Lv=vt({...$d(),...zv(),...rs(),...iv()},"VDataTable"),Ov=wt()({name:"VDataTable",props:Lv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=_d(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Xd(e),{page:c,itemsPerPage:d}=Md(e),{disableSort:v}=t.toRefs(e),{columns:p,headers:m,sortFunctions:f,sortRawFunctions:g,filterFunctions:h}=xv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:y}=Mv(e,p),b=t.toRef(()=>e.search),{filteredItems:V}=is(e,y,b,{transform:e=>e.columns,customKeyFilter:h}),{toggleSort:w}=Zd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{sortByWithGroups:k,opened:S,extractRows:x,isGroupOpen:N,toggleGroup:C}=Pd({groupBy:o,sortBy:i,disableSort:v}),{sortedItems:E}=Jd(e,V,k,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:g}),_=t.computed(()=>"auto"===e.pageBy?e.groupBy.length?"group":"item":e.pageBy),{pageCount:P,setItemsPerPage:A,paginatedItems:R}=function(e){const{sortedItems:a,paginate:l,group:n}=e,o=t.toValue(e.pageBy)
...
return{pageCount:o,setItemsPerPage:r,paginatedItems:t}}throw new Error(`Unrecognized pagination target ${o}`)}({pageBy:_,sortedItems:E,paginate:e=>{const a=t.computed(()=>t.toValue(e).length),{startIndex:l,stopIndex:n,pageCount:o,setItemsPerPage:r}=zd({page:c,itemsPerPage:d,itemsLength:a}),{paginatedItems:i}=Ld({items:e,startIndex:l,stopIndex:n,itemsPerPage:d})
return{paginatedItems:i,pageCount:o,setItemsPerPage:r}},group:e=>Bd(e,o,S,()=>!!n["group-summary"])}),T=t.computed(()=>x(R.value)),{isSelected:B,select:D,selectAll:$,toggleSelect:F,someSelected:M,allSelected:z}=Ud(e,{allItems:y,currentPage:T}),{isExpanded:L,toggleExpand:O}=Nd(e)
Dd({page:c,itemsPerPage:d,sortBy:i,groupBy:o,search:b}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return Bt(()=>{const a=sv.filterProps(e),o=Ev.filterProps(I(e,["multiSort"])),r=Tv.filterProps(e),i=Dv.filterProps(e)
return t.createVNode(Dv,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(j.value),default:()=>n.default?n.default(j.value):t.createElementVNode(t.Fragment,null,[n.colgroup?.(j.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(Ev,t.mergeProps(o,{multiSort:!!e.multiSort}),n)]),n.thead?.(j.value),!e.hideDefaultBody&&t.createElementVNode("tbody",null,[n["body.prepend"]?.(j.value),n.body?n.body(j.value):t.createVNode(Tv,t.mergeProps(l,r,{items:R.value}),n),n["body.append"]?.(j.value)]),n.tbody?.(j.value),n.tfoot?.(j.value)]),bottom:()=>n.bottom?n.bottom(j.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(ar,null,null),t.createVNode(sv,a,{prepend:n["footer.prepend"]})])})}),{}}}),jv=vt({...I(zv(),["hideDefaultFooter"]),...Ed(),...Zi(),...rs()},"VDataTableVirtual"),Hv=wt()({name:"VDataTableVirtual",props:jv(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=_d(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Xd(e),{disableSort:c}=t.toRefs(e),{columns:d,headers:v,filterFunctions:p,sortFunctions:m,sortRawFunctions:f}=xv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Mv(e,d),h=t.toRef(()=>e.search),{filteredItems:y}=is(e,g,h,{transform:e=>e.columns,customKeyFilter:p}),{toggleSort:V}=Zd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}),{sortByWithGroups:w,opened:k,extractRows:S,isGroupOpen:x,toggleGroup:N}=Pd({groupBy:o,sortBy:i,disableSort:c}),{sortedItems:C}=Jd(e,y,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:m,sortRawFunctions:f}),{flatItems:E}=Bd(C,o,k,()=>!!n["group-summary"]),_=t.computed(()=>S(E.value)),{isSelected:P,select:A,selectAll:R,toggleSelect:T,someSelected:B,allSelected:D}=Ud(e,{allItems:_,currentPage:_}),{isExpanded:$,toggleExpand:F}=Nd(e),{containerRef:M,markerRef:z,paddingTop:L,paddingBottom:O,computedItems:j,handleItemResize:H,handleScroll:W,handleScrollend:Y,calculateVisibleItems:U,scrollToIndex:G}=Qi(e,E),K=t.computed(()=>j.value.map(e=>({...e.raw,virtualIndex:e.index})))
Dd({sortBy:i,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:o,search:h}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return Bt(()=>{const a=Ev.filterProps(I(e,["multiSort"])),o=Tv.filterProps(e),r=Dv.filterProps(e)
return t.createVNode(Dv,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(q.value),wrapper:()=>t.createElementVNode("div",{ref:M,onScrollPassive:W,onScrollend:Y,class:"v-table__wrapper",style:{height:b(e.height)}},[t.createElementVNode("table",null,[n.colgroup?.(q.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(Ev,t.mergeProps(a,{multiSort:!!e.multiSort}),n)]),n.thead?.(q.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{key:"tbody"},[t.createElementVNode("tr",{ref:z,style:{height:b(L.value),border:0}},[t.createElementVNode("td",{colspan:d.value.length,style:{height:0,border:0}},null)]),n["body.prepend"]?.(q.value),t.createVNode(Tv,t.mergeProps(l,o,{items:K.value}),{...n,item:e=>t.createVNode(Xi,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>H(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return n.item?.({...e,itemRef:l})??t.createVNode(Av,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.index}),n)}})}),n["body.append"]?.(q.value),t.createElementVNode("tr",{style:{height:b(O.value),border:0}},[t.createElementVNode("td",{colspan:d.value.length,style:{height:0,border:0}},null)])]),n.tbody?.(q.value),n.tfoot?.(q.value)])]),bottom:()=>n.bottom?.(q.value)})}),{calculateVisibleItems:U,scrollToIndex:G}}}),Wv=vt({itemsLength:{type:[Number,String],required:!0},...$d(),...zv(),...iv()},"VDataTableServer"),Yv=wt()({name:"VDataTableServer",props:Wv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=_d(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Xd(e),{page:c,itemsPerPage:d}=Md(e),{disableSort:v}=t.toRefs(e),p=t.computed(()=>parseInt(e.itemsLength,10)),{columns:m,headers:f}=xv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Mv(e,m),{toggleSort:h}=Zd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{opened:y,isGroupOpen:b,toggleGroup:V,extractRows:w}=Pd({groupBy:o,sortBy:i,disableSort:v}),{pageCount:k,setItemsPerPage:S}=zd({page:c,itemsPerPage:d,itemsLength:p}),{flatItems:x}=Bd(g,o,y,()=>!!n["group-summary"]),{isSelected:N,select:C,selectAll:E,toggleSelect:_,someSelected:P,allSelected:A}=Ud(e,{allItems:g,currentPage:g}),{isExpanded:R,toggleExpand:T}=Nd(e),B=t.computed(()=>w(g.value))
Dd({page:c,itemsPerPage:d,sortBy:i,groupBy:o,search:t.toRef(()=>e.search)}),t.provide("v-data-table",{toggleSort:h,sortBy:i}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
Bt(()=>{const a=sv.filterProps(e),o=Ev.filterProps(I(e,["multiSort"])),r=Tv.filterProps(e),i=Dv.filterProps(e)
return t.createVNode(Dv,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(D.value),default:()=>n.default?n.default(D.value):t.createElementVNode(t.Fragment,null,[n.colgroup?.(D.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Ev,t.mergeProps(o,{multiSort:!!e.multiSort}),n)]),n.thead?.(D.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[n["body.prepend"]?.(D.value),n.body?n.body(D.value):t.createVNode(Tv,t.mergeProps(l,r,{items:x.value}),n),n["body.append"]?.(D.value)]),n.tbody?.(D.value),n.tfoot?.(D.value)]),bottom:()=>n.bottom?n.bottom(D.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(ar,null,null),t.createVNode(sv,a,{prepend:n["footer.prepend"]})])})})}}),Uv=vt({fluid:{type:Boolean,default:!1},...pt(),...rl(),...Pa()},"VContainer"),Gv=wt()({name:"VContainer",props:Uv(),setup(e,a){let{slots:l}=a
const{rtlClasses:n}=ga(),{dimensionStyles:o}=il(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-container",{"v-container--fluid":e.fluid},n.value,e.class]),style:t.normalizeStyle([o.value,e.style])},l)),{}}}),Kv=Eo.reduce((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e),{}),qv=Eo.reduce((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Xv=Eo.reduce((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Zv={col:Object.keys(Kv),offset:Object.keys(qv),order:Object.keys(Xv)}
function Qv(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const Jv=["auto","start","end","center","baseline","stretch"],ep=vt({cols:{type:[Boolean,String,Number],default:!1},...Kv,offset:{type:[String,Number],default:null},...qv,order:{type:[String,Number],default:null},...Xv,alignSelf:{type:String,default:null,validator:e=>Jv.includes(e)},...pt(),...Pa()},"VCol"),tp=wt()({name:"VCol",props:ep(),setup(e,a){let{slots:l}=a
const n=t.computed(()=>{const t=[]
let a
for(a in Zv)Zv[a].forEach(l=>{const n=e[l],o=Qv(a,l,n)
o&&t.push(o)})
const l=t.some(e=>e.startsWith("v-col-"))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t})
return()=>t.h(e.tag,{class:[n.value,e.class],style:e.style},l.default?.())}}),ap=["start","end","center"],lp=["space-between","space-around","space-evenly"]
function np(e,a){return Eo.reduce((l,n)=>(l[e+t.capitalize(n)]=a(),l),{})}const op=[...ap,"baseline","stretch"],rp=e=>op.includes(e),ip=np("align",()=>({type:String,default:null,validator:rp})),sp=[...ap,...lp],up=e=>sp.includes(e),cp=np("justify",()=>({type:String,default:null,validator:up})),dp=[...ap,...lp,"stretch"],vp=e=>dp.includes(e),pp=np("alignContent",()=>({type:String,default:null,validator:vp})),mp={align:Object.keys(ip),justify:Object.keys(cp),alignContent:Object.keys(pp)},fp={align:"align",justify:"justify",alignContent:"align-content"}
function gp(e,t,a){let l=fp[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const hp=vt({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:rp},...ip,justify:{type:String,default:null,validator:up},...cp,alignContent:{type:String,default:null,validator:vp},...pp,...pt(),...Pa()},"VRow"),yp=wt()({name:"VRow",props:hp(),setup(e,a){let{slots:l}=a
const n=t.computed(()=>{const t=[]
let a
for(a in mp)mp[a].forEach(l=>{const n=e[l],o=gp(a,l,n)
o&&t.push(o)})
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t})
return()=>t.h(e.tag,{class:["v-row",n.value,e.class],style:e.style},l.default?.())}}),bp=kt("v-spacer","div","VSpacer"),Vp=vt({active:{type:[String,Array],default:void 0},controlHeight:[Number,String],controlVariant:{type:String,default:"docked"},noMonthPicker:Boolean,disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Dt,default:"$next"},prevIcon:{type:Dt,default:"$prev"},modeIcon:{type:Dt,default:"$subgroup"},text:String,monthText:String,yearText:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),wp=wt()({name:"VDatePickerControls",props:Vp(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:prev-year":()=>!0,"click:next-year":()=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return{minDate:l,maxDate:n,clampDate:function(e){return l.value&&a.isBefore(e,l.value)?l.value:n.value&&a.isAfter(e,n.value)?n.value:e},isInAllowedRange:function(e){return(!l.value||a.isAfter(e,l.value))&&(!n.value||a.isBefore(e,n.value))}}}const Cp=vt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,readonly:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},events:{type:[Array,Function,Object],default:()=>null},eventColor:{type:[Array,Function,Object,String],default:()=>null},...I(xp(),["displayValue"])},"VDatePickerMonth"),Ep=wt()({name:"VDatePickerMonth",props:Cp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=t.ref(),{t:r}=ma(),{daysInMonth:i,model:s,weekNumbers:u,weekdayLabels:c}=function(e){const a=$u(),l=la(e,"modelValue",[],e=>B(e).map(e=>a.date(e))),n=t.computed(()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date()),o=la(e,"year",void 0,e=>{const t=null!=e?Number(e):a.getYear(n.value)
...
d.isBefore(t,v.value)?(p.value=d.endOfDay(v.value),v.value=t):p.value=d.endOfDay(t),s.value=function(e,t,a){const l=Bu(e,t,a),n=[t]
...
r.value=e}(o)}
return n.month?.({month:a,i:o,props:i})??t.createVNode(Ln,t.mergeProps({key:"month"},i),null)})])])),{}}}),Pp=vt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,allowedYears:[Array,Function]},"VDatePickerYears"),Ap=wt()({name:"VDatePickerYears",props:Pp(),directives:{vIntersect:Vl},emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=$u(),r=la(e,"modelValue"),i=t.shallowRef(!1),s=t.computed(()=>{const t=o.getYear(o.date())
let a=t-100,l=t+52
...
return n.year?.({year:a,i:o,props:i})??t.createVNode(Ln,t.mergeProps({key:"month"},i),null)})])]),[[Vl,{handler:d},null,{once:!0}]])),{}}}),Rp=vt({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,headerDateFormat:{type:String,default:"normalDateWithWeekday"},landscapeHeaderWidth:[Number,String],...I(Vp(),["active","monthText","yearText"]),...Cp({weeksInMonth:"static"}),...I(Ip(),["modelValue"]),...I(Pp(),["modelValue"]),...gd({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Tp=wt()({name:"VDatePicker",props:Rp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=$u(),{t:r}=ma(),{rtlClasses:i}=ga(),s=la(e,"modelValue",void 0,e=>B(e).map(e=>o.date(e)),t=>e.multiple?t:t[0]),u=la(e,"viewMode"),{minDate:c,maxDate:d,clampDate:v}=Np(e),p=t.computed(()=>{const e=o.date(),t=s.value?.[0]?o.date(s.value[0]):v(e)
...
i!==g.value&&(g.value=i,j()),s!==y.value&&(y.value=s,H()),V.value=o.isBefore(n,r)}),Bt(()=>{const a=hd.filterProps(e),l=I(wp.filterProps(e),["viewMode"]),o=Sp.filterProps(e),v=Ep.filterProps(e),p=I(_p.filterProps(e),["modelValue"]),f=I(Ap.filterProps(e),["modelValue"]),h={color:m.value,header:w.value,transition:C.value}
return t.createVNode(hd,t.mergeProps(a,{color:m.value,class:["v-date-picker",`v-date-picker--${u.value}`,{"v-date-picker--show-week":e.showWeek},i.value,e.class],style:[{"--v-date-picker-landscape-header-width":b(e.landscapeHeaderWidth)},e.style]}),{title:()=>n.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>n.header?t.createVNode(ol,{defaults:{VDatePickerHeader:{...h}}},{default:()=>[n.header?.(h)]}):t.createVNode(Sp,t.mergeProps({key:"header"},o,h,{onClick:"month"!==u.value?z:void 0}),{prepend:n.prepend,append:n.append}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(wp,t.mergeProps(l,{disabled:E.value,viewMode:u.value,text:S.value,monthText:x.value,yearText:N.value,"onClick:next":D,"onClick:prev":$,"onClick:nextYear":F,"onClick:prevYear":M,"onClick:month":L,"onClick:year":O}),{default:n.controls}),t.createVNode(Ya,{hideOnLeave:!0},{default:()=>["months"===u.value?t.createVNode(_p,t.mergeProps({key:"date-picker-months"},p,{modelValue:g.value,"onUpdate:modelValue":[e=>g.value=e,j],min:c.value,max:d.value,year:y.value,allowedMonths:P.value}),{month:n.month}):"year"===u.value?t.createVNode(Ap,t.mergeProps({key:"date-picker-years"},f,{modelValue:y.value,"onUpdate:modelValue":[e=>y.value=e,H],min:c.value,max:d.value,allowedYears:_.value}),{year:n.year}):t.createVNode(Ep,t.mergeProps({key:"date-picker-month"},v,{modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,month:g.value,"onUpdate:month":[e=>g.value=e,j],year:y.value,"onUpdate:year":[e=>y.value=e,H],min:c.value,max:d.value}),{day:n.day})]})]),actions:n.actions})}),{}}}),Bp=vt({actionText:String,bgColor:String,color:String,icon:Dt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...pt(),...rl(),...tn({size:void 0}),...ya()},"VEmptyState"),Dp=wt()({name:"VEmptyState",props:Bp(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
function Kp(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:""
...
for(const a of e)l.push(...await Kp(a,qp(t,a)))
a(l)})}})}function qp(e,t){return t.isDirectory?`${e}/${t.name}`:e}const Xp=vt({filterByType:String},"file-accept")
const Zp=vt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},truncateLength:{type:[Number,String],default:22},...I(Vo({prependIcon:"$file"}),["direction"]),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>B(e).every(e=>null!=e&&"object"==typeof e)},...Xp(),...Oi({clearable:!0})},"VFileInput"),Qp=wt()({name:"VFileInput",inheritAttrs:!1,props:Zp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,rejected:e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
if(a.length)for(const e of a){const a=await Kp(e,qp(".",e))
...
t&&i.value?.submit()}),t.preventDefault()}return Bt(()=>t.createElementVNode("form",{ref:i,class:t.normalizeClass(["v-form",e.class]),style:t.normalizeStyle(e.style),novalidate:!0,onReset:s,onSubmit:u},[n.default?.(r)])),xo(r,i)}}),lm=vt({color:String,...Sl(),...pt(),...ml(),...Pa({tag:"kbd"}),...ya(),...Nl()},"VKbd"),nm=wt()({name:"VKbd",props:lm(),setup(e,a){let{slots:l}=a
...
function om(e,t,a){const l=a&&e.mac?e.mac:e.default,n="icon"===t&&!l.icon||"symbol"===t&&!l.symbol?"text":t
let o=l[n]??l.text
return"text"===n&&"string"==typeof o&&o.startsWith("$")&&!o.startsWith("$vuetify.")&&(o=o.slice(1).toUpperCase()),"icon"===n?["icon",o]:[n,o]}const rm={ctrl:{mac:{symbol:"⌃",icon:"$ctrl",text:"$vuetify.hotkey.ctrl"},default:{text:"Ctrl"}},meta:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},cmd:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},shift:{mac:{symbol:"⇧",icon:"$shift",text:"$vuetify.hotkey.shift"},default:{text:"Shift"}},alt:{mac:{symbol:"⌥",icon:"$alt",text:"$vuetify.hotkey.option"},default:{text:"Alt"}},enter:{default:{symbol:"↵",icon:"$enter",text:"$vuetify.hotkey.enter"}},arrowup:{default:{symbol:"↑",icon:"$arrowup",text:"$vuetify.hotkey.upArrow"}},arrowdown:{default:{symbol:"↓",icon:"$arrowdown",text:"$vuetify.hotkey.downArrow"}},arrowleft:{default:{symbol:"←",icon:"$arrowleft",text:"$vuetify.hotkey.leftArrow"}},arrowright:{default:{symbol:"→",icon:"$arrowright",text:"$vuetify.hotkey.rightArrow"}},backspace:{default:{symbol:"⌫",icon:"$backspace",text:"$vuetify.hotkey.backspace"}},escape:{default:{text:"$vuetify.hotkey.escape"}}," ":{mac:{symbol:"␣",icon:"$space",text:"$vuetify.hotkey.space"},default:{text:"$vuetify.hotkey.space"}},"-":{default:{text:"-"}},"+":{default:{text:"+"}}},im=vt({keys:String,displayMode:{type:String,default:"icon"},keyMap:{type:Object,default:()=>rm},platform:{type:String,default:"auto"},inline:Boolean,disabled:Boolean,prefix:String,suffix:String,variant:{type:String,default:"elevated",validator:e=>["elevated","flat","tonal","outlined","text","plain","contained"].includes(e)},...pt(),...ya(),...Sl(),...ml(),...Nl(),color:String},"VHotkey"),sm=Symbol("VHotkey:AND_DELINEATOR"),um=Symbol("VHotkey:SLASH_DELINEATOR"),cm=Symbol("VHotkey:THEN_DELINEATOR")
function dm(e,t,a,l){const n=a.toLowerCase()
if(n in e){const o=om(e[n],t,l)
return"text"===o[0]&&"string"==typeof o[1]&&o[1].startsWith("$")&&!o[1].startsWith("$vuetify.")?["text",o[1].replace("$","").toUpperCase(),a]:[...o,a]}return["text",a.toUpperCase(),a]}const vm=wt()({name:"VHotkey",props:im(),setup(e){const{t:a}=ma(),{themeClasses:l}=Ca(e),{rtlClasses:n}=ga(),{borderClasses:o}=xl(e),{roundedClasses:r}=fl(e),{elevationClasses:i}=Cl(e),{colorClasses:s,colorStyles:u,variantClasses:c}=Hl(()=>({color:e.color,variant:"contained"===e.variant?"elevated":e.variant})),d=t.computed(()=>"auto"===e.platform?"undefined"!=typeof navigator&&/macintosh/i.test(navigator.userAgent):"mac"===e.platform),v=t.computed(()=>e.keys?e.keys.split(" ").map(t=>{const a=[],l=Ku(t)
for(let t=0;t<l.length;t++){const n=l[t]
t>0&&a.push(cm)
const{keys:o,separators:r}=Gu(n)
for(let t=0;t<o.length;t++){const l=o[t]
t>0&&a.push("/"===r[t-1]?um:sm),a.push(dm(e.keyMap,e.displayMode,l,d.value))}}return a}):[]),p=t.computed(()=>{if(!e.keys)return""
const t=v.value.map(t=>{const l=[]
for(const n of t)if(Array.isArray(n)){const t="icon"===n[0]||"symbol"===n[0]?dm(O(rm,e.keyMap),"text",String(n[1]),d.value)[1]:n[1]
l.push(m(t))}else n===sm?l.push(a("$vuetify.hotkey.plus")):n===um?l.push(a("$vuetify.hotkey.or")):n===cm&&l.push(a("$vuetify.hotkey.then"))
return l.join(" ")}).join(", ")
...
if(l in e){const t=om(e[l],"text",a)
return"string"==typeof t[1]?t[1]:String(t[1])}return t.toUpperCase()}(e.keyMap,String(t[2]),d.value)
return m(a)}Bt(()=>{const d=t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{key:"prefix",class:"v-hotkey__prefix"},[e.prefix]),v.value.map((l,n)=>t.createElementVNode("span",{class:"v-hotkey__combination",key:n},[l.map((l,n)=>Array.isArray(l)?function(a,l){const n="contained"===e.variant,c=n?"kbd":nm,d=["v-hotkey__key",`v-hotkey__key-${a[0]}`,...n?["v-hotkey__key--nested"]:[o.value,r.value,i.value,s.value]]
return t.createVNode(c,{key:l,class:t.normalizeClass(d),style:t.normalizeStyle(n?void 0:u.value),"aria-hidden":"true",title:f(a)},{default:()=>["icon"===a[0]?t.createVNode(nn,{icon:a[1],"aria-hidden":"true"},null):m(a[1])]})}(l,n):function(e,l){return t.createElementVNode("span",{key:l,class:"v-hotkey__divider","aria-hidden":"true"},[e===sm?"+":e===um?"/":a("$vuetify.hotkey.then")])}(l,n)),n<v.value.length-1&&t.createElementVNode("span",{"aria-hidden":"true"},[t.createTextVNode(" ")])])),e.suffix&&t.createElementVNode("span",{key:"suffix",class:"v-hotkey__suffix"},[e.suffix])])
return t.createElementVNode("div",{class:t.normalizeClass(["v-hotkey",{"v-hotkey--disabled":e.disabled,"v-hotkey--inline":e.inline,"v-hotkey--contained":"contained"===e.variant},l.value,n.value,c.value,e.class]),style:t.normalizeStyle(e.style),role:"img","aria-label":p.value},["contained"!==e.variant?d:t.createVNode(nm,{key:"contained",class:t.normalizeClass(["v-hotkey__contained-wrapper",o.value,r.value,i.value,s.value]),style:t.normalizeStyle(u.value),"aria-hidden":"true"},{default:()=>[d]})])})}}),pm=vt({disabled:Boolean,modelValue:{type:Boolean,default:null},...si()},"VHover"),mm=wt()({name:"VHover",props:pm(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=la(e,"modelValue"),{runOpenDelay:n,runCloseDelay:o}=ui(e,t=>!e.disabled&&(l.value=t))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:n,onMouseleave:o}})}}),fm=vt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...rl(),...Pa()},"VInfiniteScroll"),gm=Vt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:n,isIntersecting:o}=on()
return t.watch(o,async t=>{l("intersect",e.side,t)}),Bt(()=>t.createElementVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:n},[t.createTextVNode(" ")])),{}}}),hm=wt()({name:"VInfiniteScroll",props:fm(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:n}=a
...
return t.createVNode(a,{ref:o,class:t.normalizeClass(["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":n,"v-infinite-scroll--end":u}]),style:t.normalizeStyle(V.value)},{default:()=>[t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),n&&c&&t.createVNode(gm,{key:"start",side:"start",onIntersect:f,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(gm,{key:"end",side:"end",onIntersect:f,rootMargin:s.value},null),t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}),{reset:function(a){const l=a??e.side
p(l,"ok"),t.nextTick(()=>{"end"!==l&&c(v()-m+d()),"manual"!==e.mode&&t.nextTick(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{"both"===l?(g("start"),g("end")):g(l)})})})})})}}}}),ym=Symbol.for("vuetify:v-item-group"),bm=vt({...pt(),...Ul({selectedClass:"v-item--selected"}),...Pa(),...ya()},"VItemGroup"),Vm=wt()({name:"VItemGroup",props:bm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{isSelected:o,select:r,next:i,prev:s,selected:u}=ql(e,ym)
return()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-item-group",n.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.default?.({isSelected:o,select:r,next:i,prev:s,selected:u.value})]})}}),wm=wt()({name:"VItem",props:Gl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:n,toggle:o,selectedClass:r,value:i,disabled:s}=Kl(e,ym)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:n,toggle:o,value:i.value,disabled:s.value})}}),km=vt({...pt(),...rl(),...Zt()},"VLayout"),Sm=wt()({name:"VLayout",props:km(),setup(e,a){let{slots:l}=a
const{layoutClasses:n,layoutStyles:o,getLayoutItem:r,items:i,layoutRef:s}=ta(e),{dimensionStyles:u}=il(e)
return Bt(()=>t.createElementVNode("div",{ref:s,class:t.normalizeClass([n.value,e.class]),style:t.normalizeStyle([u.value,o.value,e.style])},[l.default?.()])),{getLayoutItem:r,items:i}}}),xm=vt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...pt(),...Qt()},"VLayoutItem"),Nm=wt()({name:"VLayoutItem",props:xm(),setup(e,a){let{slots:l}=a
...
return()=>t.createElementVNode("div",{class:t.normalizeClass(["v-layout-item",e.class]),style:t.normalizeStyle([n.value,e.style])},[l.default?.()])}}),Cm=vt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...pt(),...rl(),...Pa(),...gl({transition:"fade-transition"})},"VLazy"),Em=wt()({name:"VLazy",directives:{vIntersect:Vl},props:Cm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:n}=il(e),o=la(e,"modelValue")
function r(e){o.value||(o.value=e)}return Bt(()=>t.withDirectives(t.createVNode(e.tag,{class:t.normalizeClass(["v-lazy",e.class]),style:t.normalizeStyle([n.value,e.style])},{default:()=>[o.value&&t.createVNode(hl,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[Vl,{handler:r,options:e.options},null]])),{}}}),Im=vt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...pt()},"VLocaleProvider"),_m=wt()({name:"VLocaleProvider",props:Im(),setup(e,a){let{slots:l}=a
const{rtlClasses:n}=fa(e)
return Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-locale-provider",n.value,e.class]),style:t.normalizeStyle(e.style)},[l.default?.()])),{}}}),Pm=vt({scrollable:Boolean,...pt(),...rl(),...Pa({tag:"main"})},"VMain"),Am=wt()({name:"VMain",props:Pm(),setup(e,a){let{slots:l}=a
...
function Rm(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Tm(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=Rm(t),n=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(n-l)*Math.abs(n),a===e.length-1&&(t*=.5)}return 1e3*Rm(t)}function Bm(){const e={}
...
n.push({t:e[0],d:e[1].clientX}),o.push({t:e[0],d:e[1].clientY})}return{x:Tm(n),y:Tm(o),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Dm(){throw new Error}const $m=["start","end","left","right","top","bottom"],Fm=vt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>$m.includes(e)},sticky:Boolean,...Sl(),...pt(),...si(),...Bo({mobile:null}),...Nl(),...Qt(),...ml(),...I(pi(),["disableInitialFocus"]),...Pa({tag:"nav"}),...ya()},"VNavigationDrawer"),Mm=wt()({name:"VNavigationDrawer",props:Fm(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
const s=t.computed(()=>["left","right"].includes(i.value)),{addMovement:u,endTouch:c,getVelocity:d}=Bm()
let v=!1
const p=t.shallowRef(!1),m=t.shallowRef(0),f=t.shallowRef(0)
let g
function h(e,t){return("left"===i.value?e:"right"===i.value?document.documentElement.clientWidth-e:"top"===i.value?e:"bottom"===i.value?document.documentElement.clientHeight-e:Dm())-(t?o.value:0)}function y(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
const a="left"===i.value?(e-f.value)/o.value:"right"===i.value?(document.documentElement.clientWidth-e-f.value)/o.value:"top"===i.value?(e-f.value)/o.value:"bottom"===i.value?(document.documentElement.clientHeight-e-f.value)/o.value:Dm()
return t?$(a):a}function b(e){if(r.value)return
const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,d="left"===i.value?t<25:"right"===i.value?t>document.documentElement.clientWidth-25:"top"===i.value?a<25:"bottom"===i.value?a>document.documentElement.clientHeight-25:Dm(),p=l.value&&("left"===i.value?t<o.value:"right"===i.value?t>document.documentElement.clientWidth-o.value:"top"===i.value?a<o.value:"bottom"===i.value?a>document.documentElement.clientHeight-o.value:Dm());(d||p||l.value&&n.value)&&(g=[t,a],f.value=h(s.value?t:a,l.value),m.value=y(s.value?t:a),v=f.value>-20&&f.value<80,c(e),u(e))}function V(e){const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY
...
return t.createElementVNode(t.Fragment,null,[f,l["prepend-inner"]?.(...a)])}:void 0})}),xo({},n)}}),jm=vt({autofocus:Boolean,divider:String,focusAll:Boolean,label:{type:String,default:"$vuetify.input.otp"},length:{type:[Number,String],default:6},masked:Boolean,modelValue:{type:[Number,String],default:void 0},placeholder:String,type:{type:String,default:"number"},...Ml(),...rl(),...vo(),...C(Oi({variant:"outlined"}),["baseColor","bgColor","class","color","disabled","error","loading","rounded","style","theme","variant"])},"VOtpInput"),Hm=wt()({name:"VOtpInput",props:jm(),emits:{finish:e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
const Wm=vt({scale:{type:[Number,String],default:.5},...pt()},"VParallax"),Ym=wt()({name:"VParallax",props:Wm(),setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${c})`)}))}return Bt(()=>t.createVNode(kl,{class:t.normalizeClass(["v-parallax",{"v-parallax--active":o.value},e.class]),style:t.normalizeStyle(e.style),ref:u,cover:!0,onLoadstart:m,onLoad:m},l)),{}}}),Um=vt({...no({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Gm=wt()({name:"VRadio",props:Um(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=oo.filterProps(e)
return t.createVNode(oo,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)}),{}}}),Km=vt({height:{type:[Number,String],default:"auto"},...I(Vo(),["direction"]),...I(to(),["multiple"]),trueIcon:{type:Dt,default:"$radioOn"},falseIcon:{type:Dt,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),qm=wt()({name:"VRadioGroup",inheritAttrs:!1,props:Km(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[d&&t.createVNode(Jn,{id:l.value},{default:()=>[d]}),t.createVNode(lo,t.mergeProps(c,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:u.value,"aria-labelledby":d?l.value:void 0,multiple:!1},o,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),n)])}})}),xo({},s)}}),Xm=vt({...vo(),...Vo(),...td(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),Zm=wt()({name:"VRangeSlider",inheritAttrs:!1,props:Xm(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:n,attrs:o}=a
const r=t.ref(),i=t.ref(),s=t.ref(),{rtlClasses:u}=ga()
const c=ad(e),d=la(e,"modelValue",void 0,e=>e?.length?e.map(e=>c.roundValue(e)):[0,0]),{activeThumbRef:v,hasLabels:p,max:m,min:f,mousePressed:g,onSliderMousedown:h,onSliderTouchstart:y,position:b,trackContainerRef:V,disabled:w,readonly:k}=ld({props:e,steps:c,onSliderStart:()=>{w.value||k.value?v.value?.blur():n("start",d.value)},onSliderEnd:t=>{let{value:a}=t
...
const a=ed(t,r.value.$el,e.direction),l=ed(t,i.value.$el,e.direction),n=Math.abs(a),o=Math.abs(l)
...
return t.createVNode(e.tag,{class:t.normalizeClass(["v-rating",{"v-rating--hover":e.hover,"v-rating--readonly":e.readonly},o.value,e.class]),style:t.normalizeStyle(e.style),ref:r},{default:()=>[t.createVNode(V,{value:0,index:-1,showStar:!1},null),u.value.map((l,n)=>t.createElementVNode("div",{class:"v-rating__wrapper"},[a&&"top"===e.itemLabelPosition?w({value:l,index:n,label:e.itemLabels?.[n]}):void 0,t.createElementVNode("div",{class:"v-rating__item"},[e.halfIncrements?t.createElementVNode(t.Fragment,null,[t.createVNode(V,{value:l-.5,index:2*n},null),t.createVNode(V,{value:l,index:2*n+1},null)]):t.createVNode(V,{value:l,index:n},null)]),a&&"bottom"===e.itemLabelPosition?w({value:l,index:n,label:e.itemLabels?.[n]}):void 0]))]})}),{}}}),ef={actions:"button@2",article:"heading, paragraph",avatar:"avatar",button:"button",card:"image, heading","card-avatar":"image, list-item-avatar",chip:"chip","date-picker":"list-item, heading, divider, date-picker-options, date-picker-days, actions","date-picker-options":"text, avatar@2","date-picker-days":"avatar@28",divider:"divider",heading:"heading",image:"image","list-item":"text","list-item-avatar":"avatar, text","list-item-two-line":"sentences","list-item-avatar-two-line":"avatar, sentences","list-item-three-line":"paragraph","list-item-avatar-three-line":"avatar, paragraph",ossein:"ossein",paragraph:"text@3",sentences:"text@2",subtitle:"text",table:"table-heading, table-thead, table-tbody, table-tfoot","table-heading":"chip, text","table-thead":"heading@6","table-tbody":"table-row-divider@6","table-row-divider":"table-row, divider","table-row":"text@6","table-tfoot":"text@2, avatar@2",text:"text"}
function tf(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
return t.createElementVNode("div",{class:t.normalizeClass(["v-skeleton-loader__bone",`v-skeleton-loader__${e}`])},[a])}function af(e){const[t,a]=e.split("@")
return Array.from({length:a}).map(()=>lf(t))}function lf(e){let t=[]
if(!e)return t
const a=ef[e]
if(e===a);else{if(e.includes(","))return nf(e)
if(e.includes("@"))return af(e)
a.includes(",")?t=nf(a):a.includes("@")?t=af(a):a&&t.push(lf(a))}return[tf(e,t)]}function nf(e){return e.replace(/\s/g,"").split(",").map(lf)}const of=vt({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...rl(),...Nl(),...ya()},"VSkeletonLoader"),rf=wt()({name:"VSkeletonLoader",inheritAttrs:!1,props:of(),setup(e,a){let{attrs:l,slots:n}=a
const{backgroundColorClasses:o,backgroundColorStyles:r}=vl(()=>e.color),{dimensionStyles:i}=il(e),{elevationClasses:s}=Cl(e),{themeClasses:u}=Ca(e),{t:c}=ma(),d=t.computed(()=>lf(B(e.type).join(",")))
return Bt(()=>{const a=!n.default||e.loading,v=e.boilerplate||!a?{}:{ariaLive:"polite",ariaLabel:c(e.loadingText),role:"alert"}
return a?t.createElementVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},u.value,o.value,s.value],style:[r.value,i.value]},v,l),[d.value]):t.createElementVNode(t.Fragment,null,[n.default?.()])}),{}}}),sf=wt()({name:"VSlideGroupItem",props:Gl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=Kl(e,Uo)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const uf=vt({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...Il({location:"bottom"}),...hn(),...ml(),...jl(),...ya(),...I(Pi({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","retainFocus","captureFocus","disableInitialFocus","scrim","scrollStrategy","stickToTarget","viewportMargin"])},"VSnackbar"),cf=wt()({name:"VSnackbar",props:uf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
Bt(()=>{const a=!(!e.closable&&!n.actions),{modelValue:l,...o}=cf.filterProps(e)
return t.createElementVNode(t.Fragment,null,[i.value&&!!s.value&&(n.default?t.createVNode(ol,{defaults:{VSnackbar:s.value}},{default:()=>[n.default({item:s.value})]}):t.createVNode(cf,t.mergeProps(o,s.value,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,onAfterLeave:u}),{text:n.text?()=>n.text?.({item:s.value}):void 0,actions:a?()=>t.createElementVNode(t.Fragment,null,[n.actions?t.createVNode(ol,{defaults:{VBtn:v.value}},{default:()=>[n.actions({item:s.value,props:{onClick:d}})]}):t.createVNode(Ln,t.mergeProps(v.value,{onClick:d}),null)]):void 0}))])})}}),pf=vt({autoDraw:Boolean,autoDrawDuration:[Number,String],autoDrawEasing:{type:String,default:"ease"},color:String,gradient:{type:Array,default:()=>[]},gradientDirection:{type:String,validator:e=>["top","bottom","left","right"].includes(e),default:"top"},height:{type:[String,Number],default:75},labels:{type:Array,default:()=>[]},labelSize:{type:[Number,String],default:7},lineWidth:{type:[String,Number],default:4},id:String,itemValue:{type:String,default:"value"},modelValue:{type:Array,default:()=>[]},min:[String,Number],max:[String,Number],padding:{type:[String,Number],default:8},showLabels:Boolean,smooth:[Boolean,String,Number],width:{type:[Number,String],default:300}},"Line"),mf=vt({autoLineWidth:Boolean,...pf()},"VBarline"),ff=wt()({name:"VBarline",props:mf(),setup(e,a){let{slots:l}=a
...
function gf(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:75
if(0===e.length)return""
const n=e.shift(),o=e[e.length-1]
return(a?`M${n.x} ${l-n.x+2} L${n.x} ${n.y}`:`M${n.x} ${n.y}`)+e.map((a,l)=>{const o=e[l+1],r=e[l-1]||n,i=o&&(u=a,c=r,hf((s=o).x+c.x)===hf(2*u.x)&&hf(s.y+c.y)===hf(2*u.y))
var s,u,c
if(!o||i)return`L${a.x} ${a.y}`
const d=Math.min(yf(r,a),yf(o,a)),v=d/2<t?d/2:t,p=bf(r,a,v),m=bf(o,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${m.x} ${m.y}`}).join("")+(a?`L${o.x} ${l-n.x+2} Z`:"")}function hf(e){return parseInt(e,10)}function yf(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function bf(e,t,a){const l=e.x-t.x,n=e.y-t.y,o=Math.sqrt(l*l+n*n),r=l/o,i=n/o
return{x:t.x+r*a,y:t.y+i*a}}const Vf=vt({fill:Boolean,...pf()},"VTrendline"),wf=wt()({name:"VTrendline",props:Vf(),setup(e,a){let{slots:l}=a
...
return gf(u(f.value,m.value),a,t,parseInt(e.height,10))}t.watch(()=>e.modelValue,async()=>{if(await t.nextTick(),!e.autoDraw||!s.value||c())return
...
Bt(()=>{const a="trend"===e.type?wf:ff,r="trend"===e.type?wf.filterProps(e):ff.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:n.value,style:o.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)})}}),xf=vt({...pt(),...Ri({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),Nf=wt()({name:"VSpeedDial",props:xf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.withDirectives(t.createElementVNode("button",{class:t.normalizeClass(["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},n?.selectedClass.value]),disabled:!e.editable,type:"button",onClick:function(){n?.toggle()}},[i.value&&Ol(!0,"v-stepper-item"),t.createVNode(Zn,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(nn,{icon:d.value},null):o.value)]}),t.createElementVNode("div",{class:"v-stepper-item__content"},[r&&t.createElementVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createElementVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[Mn,e.editable&&e.ripple,null]])}),{}}}),Tf=vt({...I($c(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),Bf=wt()({name:"VStepperWindow",props:Tf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=t.inject(Cf,null),o=la(e,"modelValue"),r=t.computed({get:()=>null==o.value&&n?n.items.value.find(e=>n.selected.value.includes(e.id))?.value:o.value,set(e){o.value=e}})
return Bt(()=>{const a=Fc.filterProps(e)
return t.createVNode(Fc,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)}),{}}}),Df=vt({...Lc()},"VStepperWindowItem"),$f=wt()({name:"VStepperWindowItem",props:Df(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=Oc.filterProps(e)
return t.createVNode(Oc,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)}),{}}}),Ff=vt({altLabels:Boolean,bgColor:String,completeIcon:Dt,editIcon:Dt,editable:Boolean,errorIcon:Dt,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},nonLinear:Boolean,flat:Boolean,...Bo()},"Stepper"),Mf=vt({...Ff(),...Ul({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...Bi(),...C(Ef(),["prevText","nextText"])},"VStepper"),zf=wt()({name:"VStepper",props:Mf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:n,next:o,prev:r,selected:i}=ql(e,Cf),{displayClasses:s,mobile:u}=Do(e),{completeIcon:c,editIcon:d,errorIcon:v,color:p,editable:m,prevText:f,nextText:g}=t.toRefs(e),y=t.computed(()=>e.items.map((t,a)=>{const l={title:h(t,e.itemTitle,t),value:h(t,e.itemValue,a+1),...!0===e.itemProps?t:h(t,e.itemProps)}
...
return t.createVNode(Di,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":u.value},s.value,e.class],style:e.style}),{default:()=>[n&&t.createVNode(_f,{key:"stepper-header"},{default:()=>[y.value.map((e,a)=>{let{raw:n,...o}=e
return t.createElementVNode(t.Fragment,null,[!!a&&t.createVNode(ar,null,null),t.createVNode(Rf,o.props,{default:l[`header-item.${o.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])})]}),i&&t.createVNode(Bf,{key:"stepper-window"},{default:()=>[y.value.map(e=>t.createVNode($f,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)}))]}),l.default?.({prev:r,next:o}),c&&(l.actions?.({next:o,prev:r})??t.createVNode(If,{key:"stepper-actions","onClick:prev":r,"onClick:next":o},l))]})}),{prev:r,next:o}}}),Lf=vt({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...Vo(),...no()},"VSwitch"),Of=wt()({name:"VSwitch",inheritAttrs:!1,props:Lf(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[l,t.createElementVNode("div",{class:t.normalizeClass(["v-switch__thumb",{"v-switch__thumb--filled":o||e.loading},e.inset||m?void 0:r.value]),style:t.normalizeStyle(e.inset?void 0:i.value)},[n.thumb?t.createVNode(ol,{defaults:{VIcon:{icon:o,size:"x-small"}}},{default:()=>[n.thumb({...h,icon:o})]}):t.createVNode(Ua,null,{default:()=>[e.loading?t.createVNode(fn,{name:"v-switch",active:!0,color:!1===g.value?void 0:f.value},{default:e=>n.loader?n.loader(e):t.createVNode(un,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):o&&t.createVNode(nn,{key:String(o),icon:o,size:"x-small"},null)]})])])}})}})}),xo({},p)}}),jf=vt({color:String,height:[Number,String],window:Boolean,...pt(),...Nl(),...Qt(),...ml(),...Pa(),...ya()},"VSystemBar"),Hf=wt()({name:"VSystemBar",props:jf(),setup(e,a){let{slots:l}=a
...
return Bt(()=>{const a=Fc.filterProps(e)
return t.createVNode(Fc,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)}),{}}}),qf=vt({...Lc()},"VTabsWindowItem"),Xf=wt()({name:"VTabsWindowItem",props:qf(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=Oc.filterProps(e)
return t.createVNode(Oc,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)}),{}}})
const Zf=vt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,inset:Boolean,insetPadding:[String,Number],insetRadius:[String,Number],sliderColor:String,...C(Yf(),["spaced","sliderTransition","sliderTransitionDuration"]),...Go({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Ml(),...Pa()},"VTabs"),Qf=wt()({name:"VTabs",props:Zf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[t.createVNode(Ko,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--inset":e.inset,"v-tabs--stacked":e.stacked},i.value,s.value,e.class],style:[{"--v-tabs-height":b(e.height),"--v-tabs-inset-padding":e.inset?b(e.insetPadding):void 0,"--v-tabs-inset-radius":e.inset?b(e.insetRadius):void 0},u.value,e.style],role:"tablist",symbol:Wf},c,l),{default:n.default??(()=>r.value.map(a=>n.tab?.({item:a})??t.createVNode(Uf,t.mergeProps(a,{key:a.text,value:a.value,spaced:e.spaced}),{default:n[`tab.${a.value}`]?()=>n[`tab.${a.value}`]?.({item:a}):void 0}))),prev:n.prev,next:n.next}),d&&t.createVNode(Kf,t.mergeProps({modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,key:"tabs-window"},c),{default:()=>[r.value.map(e=>n.item?.({item:e})??t.createVNode(Xf,{value:e.value},{default:()=>n[`item.${e.value}`]?.({item:e})})),n.window?.()]})])}),{}}}),Jf=vt({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxHeight:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...Hi(),...I(Vo(),["direction"]),...Oi()},"VTextarea"),eg=wt()({name:"VTextarea",directives:{vIntersect:Vl},inheritAttrs:!1,props:Jf(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,"update:rows":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
case"end":return t[1]
default:return null}})
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},n.value,o.value,i.value,r.value,e.class]),style:t.normalizeStyle([{"--v-timeline-line-thickness":b(e.lineThickness)},e.style])},l)),{}}}),ug=vt({allowedValues:Function,ampm:Boolean,color:String,disabled:Boolean,displayedValue:null,double:Boolean,format:{type:Function,default:e=>e},max:{type:Number,required:!0},min:{type:Number,required:!0},scrollable:Boolean,readonly:Boolean,rotate:{type:Number,default:0},step:{type:Number,default:1},modelValue:{type:Number}},"VTimePickerClock"),cg=wt()({name:"VTimePickerClock",props:ug(),emits:{change:e=>!0,input:e=>!0},setup(e,a){let{emit:l}=a
...
return t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock__item":!0,"v-time-picker-clock__item--active":l,"v-time-picker-clock__item--disabled":e.disabled||!S(a)},l&&p.value]),style:t.normalizeStyle([I(a),l&&m.value])},[t.createElementVNode("span",null,[e.format(a)])])})])]))}}),dg=vt({active:Boolean,color:String,disabled:Boolean,label:String,modelValue:String,error:String,showHint:Boolean,readonly:Boolean},"VTimePickerField"),vg=wt()({name:"VTimePickerField",props:dg(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l}=a
...
function pg(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:2
return String(e).padStart(t,"0")}function mg(e){return e?(e-1)%12+1:12}function fg(e,t){return e%12+("pm"===t?12:0)}function gg(e){const t=e.replaceAll(/\D/g,"")
return t.length>0?Number(t):null}const hg=vt({allowedHours:[Function,Array],allowedMinutes:[Function,Array],allowedSeconds:[Function,Array],max:String,min:String},"time-validation")
function yg(e){const a=t.computed(()=>{const t=e.min?Number(e.min.split(":")[0]):0,a=e.max?Number(e.max.split(":")[0]):23
...
for(let e=1;e<=c&&!s(t=u(t));e++);return t}}}const bg=vt({ampm:Boolean,color:String,disabled:Boolean,inputHints:Boolean,hour:[Number,String],minute:[Number,String],second:[Number,String],period:String,readonly:Boolean,useSeconds:Boolean,value:Number,viewMode:String,...hg()},"VTimePickerControls"),Vg=wt()({name:"VTimePickerControls",props:bg(),emits:{"update:period":e=>!0,"update:viewMode":e=>!0,"update:hour":e=>!0,"update:minute":e=>!0,"update:second":e=>!0},setup(e,a){let{emit:l}=a
const{t:n}=ma(),{isAllowedHour:o,isAllowedMinute:r,isAllowedSecond:i,findNextAllowed:s}=yg(e),u=t.computed(()=>null!==e.hour?e.ampm?fg(Number(e.hour),e.period??"am"):Number(e.hour):null),c=t.computed(()=>null!==e.minute?Number(e.minute):null),d=t.computed(()=>null===e.hour||(o.value?.(Number(u.value))??!0)),v=t.computed(()=>null===e.minute||(r.value?.(u.value,Number(e.minute))??!0)),p=t.computed(()=>null===e.second||(i.value?.(u.value,c.value,Number(e.second))??!0)),m=t=>{if(null==t||isNaN(Number(t)))return null
const a=Number(t)
return e.ampm?pg(mg(a)):pg(a)},f=t=>{if(isNaN(Number(t))||null==t||""===t)return null
const a="string"==typeof t?gg(t):Number(t)
return null===a?null:e.ampm?fg(a,e.period??"am"):$(a,0,23)},g=la(e,"hour",void 0,m,f),h=e=>null==e||isNaN(Number(e))?null:pg(`${e}`),y=e=>{if(isNaN(Number(e))||null==e||""===e)return null
const t="string"==typeof e?gg(e):Number(e)
...
const n="am"===e.period,o=e.ampm?fg(Number(g.value??0),n?"am":"pm"):Number(g.value??0),r=s("hour",o,"ArrowUp"===a.key),i=n&&r>=12||!n&&r<12
e.ampm&&i?(l("update:period","am"===e.period?"pm":"am"),t.nextTick(()=>g.value=pg(r))):g.value=pg(r)}function k(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(b.value??0),a=s("minute",t,"ArrowUp"===e.key,u.value)
b.value=pg(a)}function S(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(V.value??0),a=s("second",t,"ArrowUp"===e.key,u.value,c.value)
V.value=pg(a)}function x(t,a,l){return n=>{if(!n.data)return
const o=n.target,{value:r,selectionStart:i,selectionEnd:s}=o??{}
if(null===gg(n.data))return void n.preventDefault()
...
if(gg(u)>t)return n.preventDefault(),o.value=pg(String(gg(n.data)).substring(0,2)),void l(o.value)}const c=t(u)
...
i.value=n?fg(parseInt(t,10),n):parseInt(t,10),s.value=parseInt(a,10),u.value=parseInt(l||0,10)}p.value=null==i.value||i.value<12?"am":"pm"}function N(e){"hour"===m.value?i.value=h.value?fg(e,p.value):e:"minute"===m.value?s.value=e:u.value=e}function C(t){switch(m.value||"hour"){case"hour":l("update:hour",t)
break
...
return l.default?.(...a)??e.text}})}),xo({},s)}}),Eg=vt({...I(Vr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand"}),["subgroup"])},"VTreeviewGroup"),Ig=wt()({name:"VTreeviewGroup",props:Eg(),setup(e,a){let{slots:l}=a
...
return ie(l.header,{props:m,item:a.raw,internalItem:a,loading:p},()=>t.createVNode(Ag,t.mergeProps({ref:e=>o.value[u]=e},m,{hasCustomPrepend:!!l.prepend,value:e.returnObject?a.raw:v.value,loading:p}),b))},default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(Tg,t.mergeProps(w,{items:d,indentLinesVariant:e.indentLinesVariant,parentIndentLines:y.children,isLastGroup:m,returnObject:e.returnObject}),l),l.footer?.({props:k,item:a.raw,internalItem:a,loading:p})])}):ie(l.item,{props:v,item:a.raw,internalItem:a},()=>"divider"===a.type?ie(l.divider,{props:a.raw},()=>t.createVNode(ar,a.props,null)):"subheader"===a.type?ie(l.subheader,{props:a.raw},()=>t.createVNode(Ir,a.props,null)):t.createVNode(Ag,t.mergeProps(v,{hasCustomPrepend:!!l.prepend,hideActions:e.hideActions,indentLines:y.leaf,value:e.returnObject?t.toRaw(a.raw):v.value}),b))})}})
function Bg(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
for(const a of e)t.push(a),a.children&&Bg(a.children,t)
return t}const Dg=vt({openAll:Boolean,indentLines:[Boolean,String],indentLinesColor:String,indentLinesOpacity:[String,Number],search:String,hideNoData:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},...rs({filterKeys:["title"]}),...I(Rg(),["index","path","indentLinesVariant","parentIndentLines","isLastGroup"]),...I(Lr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand",slim:!0}),["nav","openStrategy"]),modelValue:Array},"VTreeview"),$g=wt()({name:"VTreeview",props:Dg(),emits:{"update:opened":e=>!0,"update:activated":e=>!0,"update:selected":e=>!0,"update:modelValue":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l,emit:n}=a
const{t:o}=ma(),{items:r}=zr(e),i=t.toRef(()=>e.activeColor),s=t.toRef(()=>e.baseColor),u=t.toRef(()=>e.color),c=la(e,"activated"),d=la(e,"selected"),v=t.computed({get:()=>e.modelValue??d.value,set(e){d.value=e,n("update:modelValue",e)}}),p=t.ref(),m=t.computed(()=>e.openAll?V(r.value):e.opened),f=t.computed(()=>Bg(r.value)),g=t.toRef(()=>e.search),{filteredItems:h}=is(e,f,g),y=t.computed(()=>{if(!g.value)return null
...
return l}return t.provide(_g,{visibleIds:y}),yt({VTreeviewGroup:{activeColor:i,baseColor:s,color:u,collapseIcon:t.toRef(()=>e.collapseIcon),expandIcon:t.toRef(()=>e.expandIcon)},VTreeviewItem:{activeClass:t.toRef(()=>e.activeClass),activeColor:i,baseColor:s,color:u,density:t.toRef(()=>e.density),disabled:t.toRef(()=>e.disabled),lines:t.toRef(()=>e.lines),variant:t.toRef(()=>e.variant)}}),Bt(()=>{const a=Or.filterProps(e),n=Tg.filterProps(e),i="boolean"==typeof e.indentLines?"default":e.indentLines
return t.createVNode(Or,t.mergeProps({ref:p},a,{class:["v-treeview",{"v-treeview--fluid":e.fluid},e.class],role:"tree",openStrategy:"multiple",style:[{"--v-treeview-indent-line-color":e.indentLinesColor,"--v-treeview-indent-line-opacity":e.indentLinesOpacity},e.style],opened:m.value,activated:c.value,"onUpdate:activated":e=>c.value=e,selected:v.value,"onUpdate:selected":e=>v.value=e}),{default:()=>[0===y.value?.size&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Cr,{key:"no-data",title:o(e.noDataText)},null)),t.createVNode(Tg,t.mergeProps(n,{density:e.density,returnObject:e.returnObject,items:r.value,parentIndentLines:e.indentLines?[]:void 0,indentLinesVariant:i}),l)]})}),{}}}),Fg=wt()({name:"VValidation",props:yo(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=bo(e,"validation")
return()=>a.default?.(l)}})
var Mg=Object.freeze({__proto__:null,VAlert:qn,VAlertTitle:Wn,VApp:_a,VAppBar:$l,VAppBarNavIcon:jn,VAppBarTitle:Hn,VAutocomplete:fs,VAvatar:Zn,VBadge:hs,VBanner:ks,VBannerActions:bs,VBannerText:Vs,VBottomNavigation:xs,VBottomSheet:Is,VBreadcrumbs:Bs,VBreadcrumbsDivider:Ps,VBreadcrumbsItem:Rs,VBtn:Ln,VBtnGroup:Yl,VBtnToggle:Jl,VCalendar:Vc,VCard:Ac,VCardActions:kc,VCardItem:Ec,VCardSubtitle:xc,VCardText:_c,VCardTitle:Nc,VCarousel:zc,VCarouselItem:Hc,VCheckbox:Co,VCheckboxBtn:io,VChip:Jo,VChipGroup:Zo,VClassIcon:Ot,VCode:Wc,VCol:tp,VColorPicker:yd,VCombobox:Vd,VComponentIcon:Mt,VConfirmEdit:kd,VContainer:Gv,VCounter:Fi,VDataIterator:nv,VDataTable:Ov,VDataTableFooter:sv,VDataTableHeaders:Ev,VDataTableRow:Av,VDataTableRows:Tv,VDataTableServer:Yv,VDataTableVirtual:Hv,VDatePicker:Tp,VDatePickerControls:wp,VDatePickerHeader:Sp,VDatePickerMonth:Ep,VDatePickerMonths:_p,VDatePickerYears:Ap,VDefaultsProvider:ol,VDialog:Cs,VDialogBottomTransition:Ha,VDialogTopTransition:Wa,VDialogTransition:za,VDivider:ar,VEmptyState:Dp,VExpandBothTransition:ll,VExpandTransition:tl,VExpandXTransition:al,VExpansionPanel:jp,VExpansionPanelText:Mp,VExpansionPanelTitle:Lp,VExpansionPanels:Yp,VFab:Gp,VFabTransition:ja,VFadeTransition:Ya,VField:ji,VFieldLabel:zi,VFileInput:Qp,VFooter:em,VForm:am,VHotkey:vm,VHover:mm,VIcon:nn,VImg:kl,VInfiniteScroll:hm,VInput:wo,VItem:wm,VItemGroup:Vm,VKbd:nm,VLabel:Jn,VLayout:Sm,VLayoutItem:Nm,VLazy:Em,VLigatureIcon:Lt,VList:Or,VListGroup:wr,VListImg:jr,VListItem:Cr,VListItemAction:Wr,VListItemMedia:Ur,VListItemSubtitle:Sr,VListItemTitle:xr,VListSubheader:Ir,VLocaleProvider:_m,VMain:Am,VMenu:Ti,VMessages:co,VNavigationDrawer:Mm,VNoSsr:zm,VNumberInput:Om,VOtpInput:Hm,VOverlay:Ai,VPagination:rv,VParallax:Ym,VProgressCircular:un,VProgressLinear:vn,VRadio:Gm,VRadioGroup:qm,VRangeSlider:Zm,VRating:Jm,VResponsive:ul,VRow:yp,VScaleTransition:Ua,VScrollXReverseTransition:Ka,VScrollXTransition:Ga,VScrollYReverseTransition:Xa,VScrollYTransition:qa,VSelect:ps,VSelectionControl:oo,VSelectionControlGroup:lo,VSheet:Di,VSkeletonLoader:rf,VSlideGroup:Ko,VSlideGroupItem:sf,VSlideXReverseTransition:Qa,VSlideXTransition:Za,VSlideYReverseTransition:el,VSlideYTransition:Ja,VSlider:ud,VSnackbar:cf,VSnackbarQueue:vf,VSpacer:bp,VSparkline:Sf,VSpeedDial:Nf,VStepper:zf,VStepperActions:If,VStepperHeader:_f,VStepperItem:Rf,VStepperWindow:Bf,VStepperWindowItem:$f,VSvgIcon:zt,VSwitch:Of,VSystemBar:Hf,VTab:Uf,VTable:Dv,VTabs:Qf,VTabsWindow:Kf,VTabsWindowItem:Xf,VTextField:Ki,VTextarea:eg,VThemeProvider:ag,VTimePicker:kg,VTimePickerClock:cg,VTimePickerControls:Vg,VTimeline:sg,VTimelineItem:rg,VToolbar:Rl,VToolbarItems:xg,VToolbarTitle:Ra,VTooltip:Cg,VTreeview:$g,VTreeviewGroup:Ig,VTreeviewItem:Ag,VValidation:Fg,VVirtualScroll:es,VWindow:Fc,VWindowItem:Oc})
function zg(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Lg={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:n,immediate:o,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver(function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),n&&zg(e,t)})
o&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:zg}
function Og(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,n="object"==typeof l&&l.options||{passive:!0},o="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",o,n),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:o,options:n,target:a?void 0:r})}function jg(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:n=e}=e._onScroll[t.instance.$.uid]
n.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const Hg={mounted:Og,unmounted:jg,updated:function(e,t){t.value!==t.oldValue&&(jg(e,t),Og(e,t))}}
const Wg=function(e,a){const n=function(e,a){return function(n,o,r){const i="function"==typeof a?a(o):a,s=o.value?.text??o.value??i?.text,u=V(o.value)?o.value:{},c=()=>s??n.textContent,d=(r.ctx===o.instance.$?function(e,t){const a=new Set,n=t=>{for(const l of t){if(!l)continue
...
return{mounted:n,updated:n,unmounted(e){t.render(null,e)}}}(Cg,e=>({activator:(V(e.value)?!e.value.text:["",!1,null].includes(e.value))?null:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value}))
var Yg=Object.freeze({__proto__:null,ClickOutside:Ii,Intersect:Vl,Mutate:Lg,Resize:Ou,Ripple:Mn,Scroll:Hg,Tooltip:Wg,Touch:Tc})
function Ug(e){const t={svg:{component:zt},class:{component:Ot}},a=e?.defaultSet??"mdi"
return"mdi"!==a||t.mdi||(t.mdi=Ht),O({defaultSet:a,sets:t,aliases:{...jt,vuetify:["M8.2241 14.2009L12 21L22 3H14.4459L8.2241 14.2009Z",["M7.26303 12.4733L7.00113 12L2 3H12.5261C12.5261 3 12.5261 3 12.5261 3L7.26303 12.4733Z",.6]],"vuetify-outline":"svg:M7.26 12.47 12.53 3H2L7.26 12.47ZM14.45 3 8.22 14.2 12 21 22 3H14.45ZM18.6 5 12 16.88 10.51 14.2 15.62 5ZM7.26 8.35 5.4 5H9.13L7.26 8.35Z","vuetify-play":["m6.376 13.184-4.11-7.192C1.505 4.66 2.467 3 4.003 3h8.532l-.953 1.576-.006.01-.396.677c-.429.732-.214 1.507.194 2.015.404.503 1.092.878 1.869.806a3.72 3.72 0 0 1 1.005.022c.276.053.434.143.523.237.138.146.38.635-.25 2.09-.893 1.63-1.553 1.722-1.847 1.677-.213-.033-.468-.158-.756-.406a4.95 4.95 0 0 1-.8-.927c-.39-.564-1.04-.84-1.66-.846-.625-.006-1.316.27-1.693.921l-.478.826-.911 1.506Z",["M9.093 11.552c.046-.079.144-.15.32-.148a.53.53 0 0 1 .43.207c.285.414.636.847 1.046 1.2.405.35.914.662 1.516.754 1.334.205 2.502-.698 3.48-2.495l.014-.028.013-.03c.687-1.574.774-2.852-.005-3.675-.37-.391-.861-.586-1.333-.676a5.243 5.243 0 0 0-1.447-.044c-.173.016-.393-.073-.54-.257-.145-.18-.127-.316-.082-.392l.393-.672L14.287 3h5.71c1.536 0 2.499 1.659 1.737 2.992l-7.997 13.996c-.768 1.344-2.706 1.344-3.473 0l-3.037-5.314 1.377-2.278.004-.006.004-.007.481-.831Z",.6]]}},e)}function Gg(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:a,...l}=e,n=O(a,l),{aliases:r={},components:i={},directives:s={}}=n,u=t.effectScope()
return u.run(()=>{const e=function(e){return t.ref(e)}(n.defaults),a=To(n.display,n.ssr),l=Na(n.theme),c=Ug(n.icons),d=pa(n.locale),v=function(e,t){const a=O({adapter:Au,locale:{af:"af-ZA",bg:"bg-BG",ca:"ca-ES",ckb:"",cs:"cs-CZ",de:"de-DE",el:"el-GR",en:"en-US",et:"et-EE",fa:"fa-IR",fi:"fi-FI",hr:"hr-HR",hu:"hu-HU",he:"he-IL",id:"id-ID",it:"it-IT",ja:"ja-JP",ko:"ko-KR",lv:"lv-LV",lt:"lt-LT",nl:"nl-NL",no:"no-NO",pl:"pl-PL",pt:"pt-PT",ro:"ro-RO",ru:"ru-RU",sk:"sk-SK",sl:"sl-SI",srCyrl:"sr-SP",srLatn:"sr-SP",sv:"sv-SE",th:"th-TH",tr:"tr-TR",az:"az-AZ",uk:"uk-UA",vi:"vi-VN",zhHans:"zh-CN",zhHant:"zh-TW"}},e)
return{options:a,instance:Du(a,t)}}(n.date,d),p=function(e,t){return{rtl:t.isRtl,options:O(Fo(),e)}}(n.goTo,d)
...
if(m.run(()=>{l.install(u)}),u.onUnmount(()=>m.stop()),u.provide(gt,e),u.provide(Io,a),u.provide(ha,l),u.provide($t,c),u.provide(va,d),u.provide(Ru,v.options),u.provide(Tu,v.instance),u.provide($o,p),o&&n.ssr)if(u.$nuxt)u.$nuxt.hook("app:suspense:resolve",()=>{a.update()})
else{const{mount:e}=u
u.mount=function(){const l=e(...arguments)
return t.nextTick(()=>a.update()),u.mount=e,l}}("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&u.mixin({computed:{$vuetify(){return t.reactive({defaults:Kg.call(this,gt),display:Kg.call(this,Io),theme:Kg.call(this,ha),icons:Kg.call(this,$t),locale:Kg.call(this,va),date:Kg.call(this,Tu)})}}})},unmount:function(){u.stop()},defaults:e,display:a,theme:l,icons:c,locale:d,date:v,goTo:p}})}function Kg(e){const t=this.$,a=t.parent?.provides??t.vnode.appContext?.provides
if(a&&e in a)return a[e]}Gg.version="3.12.7"
const qg=function(){return Gg({components:Mg,directives:Yg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Xg="3.12.7"
qg.version=Xg,e.blueprints=Gt,e.components=Mg,e.createVuetify=qg,e.directives=Yg,e.useDate=$u,e.useDefaults=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=arguments.length>1?arguments[1]:void 0
...
return e&&("INPUT"===e.tagName||"TEXTAREA"===e.tagName||e.isContentEditable||"true"===e.contentEditable)}())if(function(e,t,a){const{modifiers:l,actualKey:n}=function(e){const t=["ctrl","shift","alt","meta","cmd"],{keys:a}=Gu(e.toLowerCase())
...
else n+=i,t++}return n}function u(e){return!!e&&s(e)===s(i(e))}return{isValid:u,isComplete:function(e){return!!e&&(i(e).length===a.value.length&&u(e))},mask:i,unmask:s}},e.useRtl=ga,e.useTheme=Ea,e.version=Xg})
